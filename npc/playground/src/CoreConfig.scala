...
trait DeviceAddr{
  ...
  def SERIAL_PORT = DEVICE_BASE + "h0x00003f8".U(32.W)
  def RTC_ADDR    = DEVICE_BASE + "h0x0000048".U(32.W)
  def KBD_ADDR    = DEVICE_BASE + "h0x0000060".U(32.W)
  def VGACTL_ADDR = DEVICE_BASE + "h0x0000100".U(32.W)
  def SYNC_ADDR   = VGACTL_ADDR +  4.U(32.W)
  def FB_ADDR     = DEVICE_BASE + "h0x1000000".U(32.W)
