...
class LS_stage extends Module {
  ...
  LS.to_wb.bits.id_inv_flag:=LS.IO.bits.id_inv_flag
  LS.to_wb.bits.ex_func_flag:=LS.IO.bits.ex_func_flag
  LS.to_wb.bits.ex_is_jal:=LS.IO.bits.ex_is_jal
  LS.to_wb.bits.ex_is_ret:=LS.IO.bits.ex_is_ret
  LS.to_wb.bits.ex_is_rd0:=LS.IO.bits.ex_is_rd0
}
