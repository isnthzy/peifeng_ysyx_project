...
module RegFile(	// <stdin>:8:3
  ...
  `ifdef ENABLE_INITIAL_REG_	// <stdin>:8:3
    ...
    initial begin	// <stdin>:8:3
      automatic logic [31:0] _RANDOM[0:31];	// <stdin>:8:3
  ...
  assign io_rdata1 = (|io_raddr1) ? _GEN[io_raddr1] : 32'h0;	// <stdin>:8:3, playground/src/RegFile.scala:14:25, :16:{17,27}
  assign io_rdata2 = (|io_raddr2) ? _GEN[io_raddr2] : 32'h0;	// <stdin>:8:3, playground/src/RegFile.scala:14:25, :16:17, :17:{17,27}
endmodule
...
module SimTop(	// <stdin>:92:3
  ...
  `ifdef ENABLE_INITIAL_REG_	// <stdin>:92:3
    ...
    initial begin	// <stdin>:92:3
      automatic logic [31:0] _RANDOM[0:0];	// <stdin>:92:3
