...
module SimTop(	// <stdin>:3:3
  ...
  wire [3:0]      _sub_T = io_a - io_b;	// playground/src/SimTop.scala:18:16
  ...
  wire [7:0][3:0] _GEN =
    {{{3'h0, io_a == io_b}},
     ...
     {~io_a},
     {_sub_T},
     {sum[3:0]}};	// playground/src/SimTop.scala:13:16, :14:35, :18:16, :22:15, :24:19, :26:19, :28:19, :30:23, :32:23, :33:34
  ...
  assign io_of =
    _io_out_c_T_2
      ...
      : _io_out_c_T & io_a[3] & io_b[3] & sum[3] != io_a[3];	// <stdin>:3:3, playground/src/SimTop.scala:13:16, :14:35, :15:{26,35,48,51}, :18:16, :20:{39,48,51}, :33:34, :39:33
  assign io_out_c = ~_io_out_c_T_2 & _io_out_c_T & sum[4];	// <stdin>:3:3, playground/src/SimTop.scala:13:16, :14:28, :33:34, :39:33, :42:36
endmodule
