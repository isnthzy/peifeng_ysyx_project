...
module SimTop(	// <stdin>:3:3
  ...
  wire [2:0]      sum = io_a[2:0] + io_b[2:0];	// playground/src/SimTop.scala:12:18
  wire            _io_of_T_2 = io_op == 3'h1;	// playground/src/SimTop.scala:26:34
  wire [2:0]      _io_out_T_3 = _io_of_T_2 ? io_a[2:0] - io_b[2:0] : sum;	// playground/src/SimTop.scala:12:18, :16:18, :26:34
  ...
  assign io_of =
    _io_of_T_2
      ...
      : io_op == 3'h0 & io_a[3] == io_b[3] & sum[2] != io_a[3];	// <stdin>:3:3, playground/src/SimTop.scala:12:18, :13:39, :14:{27,31,39,54,58}, :18:{31,44,56}, :26:34, :32:33
endmodule
