...
module DPI_stage(	// @[<stdin>:1509:3]
  ...
  Dpi_CsrCommit dpi_csrcommit (	// @[playground/src/Dpi_stage.scala:60:27]
    .clock         (clock),
    .reset         (reset),
    .dpi_valid     (DPI_wb_valid),
    .csr_wen       (DPI_csr_commit_wen),
    .waddr         ({20'h0, DPI_csr_commit_waddr}),	// @[playground/src/Dpi_stage.scala:65:25]
    .wdata         (DPI_csr_commit_wdata),
    .exception_wen (DPI_csr_commit_exception_wen),
    .mcause_in     ({28'h0, DPI_csr_commit_exception_mcause_in}),	// @[playground/src/Dpi_stage.scala:68:29]
