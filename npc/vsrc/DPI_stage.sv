...
module DPI_stage(	// @[<stdin>:1433:3]
  ...
  Dpi_CsrCommit Dpi_CsrCommit (	// @[playground/src/Dpi_stage.scala:61:27]
    .clock                          (clock),
    .reset                          (reset),
    .csr_commit_wen                 (DPI_csr_commit_wen),
    .csr_commit_waddr               (DPI_csr_commit_waddr),
    .csr_commit_wdata               (DPI_csr_commit_wdata),
    .csr_commit_exception_wen       (DPI_csr_commit_exception_wen),
    .csr_commit_exception_mcause_in (DPI_csr_commit_exception_mcause_in),
    .csr_commit_exception_pc_wb     (DPI_csr_commit_exception_pc_wb)
  );
endmodule
