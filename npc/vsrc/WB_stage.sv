...
module WB_stage(	// @[<stdin>:1037:3]
  input         clock,	// @[<stdin>:1038:11]
                reset,	// @[<stdin>:1039:11]
  ...
  assign WB_to_id_waddr = WB_IO_rd;	// @[<stdin>:1037:3]
  assign WB_to_id_wdata = WB_IO_result;	// @[<stdin>:1037:3]
  assign WB_to_id_wen = WB_IO_wen;	// @[<stdin>:1037:3]
  assign WB_debug_waddr = WB_IO_rd;	// @[<stdin>:1037:3]
  assign WB_debug_wdata = WB_IO_result;	// @[<stdin>:1037:3]
  assign WB_debug_wen = WB_IO_wen;	// @[<stdin>:1037:3]
endmodule
