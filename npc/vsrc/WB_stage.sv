...
module WB_stage(	// @[<stdin>:968:3]
  input         clock,	// @[<stdin>:969:11]
                reset,	// @[<stdin>:970:11]
  ...
  assign WB_to_id_waddr = WB_IO_rd;	// @[<stdin>:968:3]
  assign WB_to_id_wdata = _WB_to_id_wdata_output;	// @[<stdin>:968:3, playground/src/WB_stage.scala:15:46]
  assign WB_to_id_wen = WB_IO_wen;	// @[<stdin>:968:3]
  assign WB_debug_waddr = WB_IO_rd;	// @[<stdin>:968:3]
  assign WB_debug_wdata = _WB_to_id_wdata_output;	// @[<stdin>:968:3, playground/src/WB_stage.scala:15:46]
  assign WB_debug_wen = WB_IO_wen;	// @[<stdin>:968:3]
endmodule
