...
module WB_stage(	// @[<stdin>:1035:3]
  input         clock,	// @[<stdin>:1036:11]
                reset,	// @[<stdin>:1037:11]
  ...
  assign WB_to_id_waddr = WB_IO_rd;	// @[<stdin>:1035:3]
  assign WB_to_id_wdata = WB_IO_result;	// @[<stdin>:1035:3]
  assign WB_to_id_wen = WB_IO_wen;	// @[<stdin>:1035:3]
  assign WB_debug_waddr = WB_IO_rd;	// @[<stdin>:1035:3]
  assign WB_debug_wdata = WB_IO_result;	// @[<stdin>:1035:3]
  assign WB_debug_wen = WB_IO_wen;	// @[<stdin>:1035:3]
endmodule
