...
module WB_stage(	// @[<stdin>:1049:3]
  input         clock,	// @[<stdin>:1050:11]
                reset,	// @[<stdin>:1051:11]
  ...
  assign WB_to_id_waddr = WB_IO_rd;	// @[<stdin>:1049:3]
  assign WB_to_id_wdata = WB_IO_result;	// @[<stdin>:1049:3]
  assign WB_to_id_wen = WB_IO_wen;	// @[<stdin>:1049:3]
  assign WB_debug_waddr = WB_IO_rd;	// @[<stdin>:1049:3]
  assign WB_debug_wdata = WB_IO_result;	// @[<stdin>:1049:3]
  assign WB_debug_wen = WB_IO_wen;	// @[<stdin>:1049:3]
endmodule
