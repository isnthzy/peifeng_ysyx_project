...
module EXE_stage(	// @[<stdin>:573:3]
  ...
  assign io_result = _io_result_output;	// @[<stdin>:573:3, playground/src/EXE_stage.scala:34:17]
  ...
  assign io_sram_wdata = {27'h0, io_d_ebus_src2};	// @[<stdin>:573:3, playground/src/EXE_stage.scala:41:16]
