...
module EXE_stage(	// @[<stdin>:571:3]
  ...
  assign io_result =
    io_d_ebus_result_is_imm
      ? io_d_ebus_imm
      : io_d_ebus_result_is_snpc ? io_d_ebus_snpc : _alu_io_result;	// @[<stdin>:571:3, playground/src/EXE_stage.scala:23:18, :34:17, :35:18]
  ...
  assign io_sram_wdata = {27'h0, io_d_ebus_src2};	// @[<stdin>:571:3, playground/src/EXE_stage.scala:39:19, :42:16]
