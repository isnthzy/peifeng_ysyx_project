...
module EXE_stage(	// @[<stdin>:540:3]
  input         clock,	// @[<stdin>:541:11]
                reset,	// @[<stdin>:542:11]
  ...
  assign io_result = _io_result_output;	// @[<stdin>:540:3, playground/src/EXE_stage.scala:33:17]
  assign io_jalr_taget = {_jalr_tmp_T[31:1], 1'h0};	// @[<stdin>:540:3, playground/src/EXE_stage.scala:10:12, :35:29, :36:{21,30}]
endmodule
