...
module EXE_stage(	// @[<stdin>:548:3]
  ...
  assign io_result = _io_result_output;	// @[<stdin>:548:3, playground/src/EXE_stage.scala:34:17]
  assign io_jalr_taget = {_jalr_tmp_T[31:1], 1'h0};	// @[<stdin>:548:3, playground/src/EXE_stage.scala:17:25, :36:29, :37:{21,30}]
endmodule
