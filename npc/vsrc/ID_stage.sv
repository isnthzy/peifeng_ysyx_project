...
module ID_stage(	// @[<stdin>:1010:3]
  ...
  output [2:0]  ID_to_ex_bits_st_type,	// @[playground/src/ID_stage.scala:7:12]
                ID_to_ex_bits_ld_type,	// @[playground/src/ID_stage.scala:7:12]
  ...
  output        ID_to_if_flush,	// @[playground/src/ID_stage.scala:7:12]
                ID_to_preif_Br_J_stall,	// @[playground/src/ID_stage.scala:7:12]
  ...
  always_comb begin	// @[playground/src/ID_stage.scala:116:38]
    casez (_dc_io_B_sel)	// @[playground/src/ID_stage.scala:33:16, :116:38]
      ...
      default:
        casez_tmp = 32'h0;	// @[playground/src/ID_stage.scala:116:38, :167:45]
    endcase	// @[playground/src/ID_stage.scala:33:16, :116:38]
  end // always_comb
  wire        _ID_to_preif_flush_T = _J_cond_io_taken & id_valid;	// @[playground/src/ID_stage.scala:23:33, :126:20, :131:43]
  always @(posedge clock) begin	// @[<stdin>:1011:11]
    if (reset)	// @[<stdin>:1011:11]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:26:28]
  assign ID_to_ex_valid = ~id_flush & id_valid & id_ready_go;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:18:30, :23:33, :24:33, :30:22]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:33:16, :166:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:41:30]
  assign ID_to_ex_bits_b_taken = _B_cond_io_taken & id_valid;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:23:33, :127:20, :145:41]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_rf_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:23:33, :33:16, :154:37]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:39:24]
  assign ID_to_ex_bits_src1 = src1;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:112:38]
  assign ID_to_ex_bits_src2 = casez_tmp;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:116:38]
  assign ID_to_ex_bits_rdata1 = rdata1;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:66:28]
  assign ID_to_ex_bits_rdata2 = rdata2;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:67:28]
  assign ID_to_ex_bits_nextpc = ID_IO_bits_nextpc;	// @[<stdin>:1010:3]
  assign ID_to_ex_bits_pc = ID_IO_bits_pc;	// @[<stdin>:1010:3]
  assign ID_to_ex_bits_inst = ID_IO_bits_inst;	// @[<stdin>:1010:3]
  assign ID_to_if_flush = _ID_to_preif_flush_T;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:131:43]
  assign ID_to_preif_Br_J_stall = _ID_to_preif_flush_T & ~id_ready_go;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:24:33, :131:{43,55,58}]
  assign ID_to_preif_Br_J_taken = _ID_to_preif_flush_T;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:131:43]
  assign ID_to_preif_flush = _ID_to_preif_flush_T;	// @[<stdin>:1010:3, playground/src/ID_stage.scala:131:43]
endmodule
