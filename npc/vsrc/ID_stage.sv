...
module ID_stage(	// @[<stdin>:999:3]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:999:3, playground/src/ID_stage.scala:26:28]
  assign ID_to_ex_valid = ~id_flush & id_valid & id_ready_go;	// @[<stdin>:999:3, playground/src/ID_stage.scala:18:30, :23:33, :24:33, :30:22]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:999:3, playground/src/ID_stage.scala:33:16, :165:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:999:3, playground/src/ID_stage.scala:41:30]
  assign ID_to_ex_bits_b_taken = _B_cond_io_taken & id_valid;	// @[<stdin>:999:3, playground/src/ID_stage.scala:23:33, :127:20, :144:41]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:999:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:999:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_rf_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:999:3, playground/src/ID_stage.scala:23:33, :33:16, :153:37]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:999:3, playground/src/ID_stage.scala:39:24]
  assign ID_to_ex_bits_src1 = src1;	// @[<stdin>:999:3, playground/src/ID_stage.scala:112:38]
  assign ID_to_ex_bits_src2 = casez_tmp;	// @[<stdin>:999:3, playground/src/ID_stage.scala:116:38]
  assign ID_to_ex_bits_rdata1 = rdata1;	// @[<stdin>:999:3, playground/src/ID_stage.scala:66:28]
  assign ID_to_ex_bits_rdata2 = rdata2;	// @[<stdin>:999:3, playground/src/ID_stage.scala:67:28]
  assign ID_to_ex_bits_nextpc = ID_IO_bits_nextpc;	// @[<stdin>:999:3]
  assign ID_to_ex_bits_pc = ID_IO_bits_pc;	// @[<stdin>:999:3]
  assign ID_to_ex_bits_inst = ID_IO_bits_inst;	// @[<stdin>:999:3]
  assign ID_to_if_flush = _ID_to_preif_flush_T;	// @[<stdin>:999:3, playground/src/ID_stage.scala:131:42]
  assign ID_to_preif_Br_J_taken = _ID_to_preif_flush_T;	// @[<stdin>:999:3, playground/src/ID_stage.scala:131:42]
  assign ID_to_preif_flush = _ID_to_preif_flush_T;	// @[<stdin>:999:3, playground/src/ID_stage.scala:131:42]
endmodule
