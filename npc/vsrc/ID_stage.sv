...
module ID_stage(	// @[<stdin>:809:3]
  ...
  input         ID_wb_bus_wen,	// @[playground/src/ID_stage.scala:7:12]
                ID_id_no_valid,	// @[playground/src/ID_stage.scala:7:12]
  ...
  wire        id_ready_go = ~ID_id_no_valid;	// @[playground/src/ID_stage.scala:17:33, :18:33, :19:19]
  ...
  wire        _rdata1_T = rs1 == ID_ex_fw_addr;	// @[playground/src/ID_stage.scala:29:25, :62:71]
  wire        _rdata1_T_1 = rs1 == ID_ls_fw_addr;	// @[playground/src/ID_stage.scala:29:25, :63:41]
  wire        _rdata2_T = _Regfile_io_raddr2_T_3 == ID_ex_fw_addr;	// @[playground/src/ID_stage.scala:52:50, :65:71]
  wire        _rdata2_T_1 = _Regfile_io_raddr2_T_3 == ID_ls_fw_addr;	// @[playground/src/ID_stage.scala:52:50, :66:41]
  wire [31:0] rdata1 =
    (|rs1) & (_rdata1_T | _rdata1_T_1 | ID_wb_bus_wen & rs1 == ID_wb_bus_waddr)
      ? (_rdata1_T ? ID_ex_fw_data : _rdata1_T_1 ? ID_ls_fw_data : ID_wb_bus_wdata)
      : _Regfile_io_rdata1;	// @[playground/src/ID_stage.scala:29:25, :50:21, :60:28, :62:{41,49,71}, :63:{41,59}, :64:{38,59}, :68:14, :69:16, :70:16]
  wire [31:0] rdata2 =
    (|_Regfile_io_raddr2_T_3)
    & (_rdata2_T | _rdata2_T_1 | ID_wb_bus_wen
       & _Regfile_io_raddr2_T_3 == ID_wb_bus_waddr)
      ? (_rdata2_T ? ID_ex_fw_data : _rdata2_T_1 ? ID_ls_fw_data : ID_wb_bus_wdata)
      : _Regfile_io_rdata2;	// @[playground/src/ID_stage.scala:50:21, :52:50, :61:28, :65:{41,49,71}, :66:{41,59}, :67:{38,59}, :73:14, :74:16, :75:16]
  ...
  always @(posedge clock) begin	// @[<stdin>:810:11]
    if (reset)	// @[<stdin>:810:11]
      ...
      id_valid <= ~ID_id_no_valid & ID_IO_valid;	// @[playground/src/ID_stage.scala:17:33, :22:18]
  end // always @(posedge)
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:809:3, playground/src/ID_stage.scala:20:28]
  assign ID_to_ex_valid = id_valid & id_ready_go;	// @[<stdin>:809:3, playground/src/ID_stage.scala:17:33, :18:33, :24:28]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:809:3, playground/src/ID_stage.scala:26:16, :114:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:809:3, playground/src/ID_stage.scala:34:30]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:809:3, playground/src/ID_stage.scala:26:16]
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:809:3, playground/src/ID_stage.scala:26:16, :52:50, :99:44]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:809:3, playground/src/ID_stage.scala:32:24]
  assign ID_to_ex_bits_src1 = _dc_io_A_sel ? _Regfile_io_rdata1 : ID_IO_bits_pc;	// @[<stdin>:809:3, playground/src/ID_stage.scala:26:16, :50:21, :80:38]
  assign ID_to_ex_bits_src2 = _dc_io_B_sel ? _Regfile_io_rdata2 : imm;	// @[<stdin>:809:3, playground/src/ID_stage.scala:26:16, :28:25, :50:21, :84:38]
  assign ID_to_ex_bits_rdata1 = _Regfile_io_rdata1;	// @[<stdin>:809:3, playground/src/ID_stage.scala:50:21]
  assign ID_to_ex_bits_rdata2 = _Regfile_io_rdata2;	// @[<stdin>:809:3, playground/src/ID_stage.scala:50:21]
