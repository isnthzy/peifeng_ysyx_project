...
module ID_stage(	// @[<stdin>:815:3]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:815:3, playground/src/ID_stage.scala:21:28]
  assign ID_to_ex_valid = ~ID_flush & id_valid & id_ready_go;	// @[<stdin>:815:3, playground/src/ID_stage.scala:18:33, :19:33, :25:22]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:815:3, playground/src/ID_stage.scala:27:16, :121:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:815:3, playground/src/ID_stage.scala:35:30]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:815:3, playground/src/ID_stage.scala:27:16]
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:815:3, playground/src/ID_stage.scala:27:16, :53:50, :106:44]
  assign ID_to_ex_bits_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:815:3, playground/src/ID_stage.scala:18:33, :27:16, :109:34]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:815:3, playground/src/ID_stage.scala:33:24]
  assign ID_to_ex_bits_src1 = _dc_io_A_sel ? rdata1 : ID_IO_bits_pc;	// @[<stdin>:815:3, playground/src/ID_stage.scala:27:16, :61:28, :87:38]
  assign ID_to_ex_bits_src2 = _dc_io_B_sel ? rdata2 : imm;	// @[<stdin>:815:3, playground/src/ID_stage.scala:27:16, :29:25, :62:28, :91:38]
  assign ID_to_ex_bits_rdata1 = _Regfile_io_rdata1;	// @[<stdin>:815:3, playground/src/ID_stage.scala:51:21]
  assign ID_to_ex_bits_rdata2 = _Regfile_io_rdata2;	// @[<stdin>:815:3, playground/src/ID_stage.scala:51:21]
  assign ID_to_ex_bits_nextpc = ID_IO_bits_nextpc;	// @[<stdin>:815:3]
  assign ID_to_ex_bits_pc = ID_IO_bits_pc;	// @[<stdin>:815:3]
  assign ID_to_ex_bits_inst = ID_IO_bits_inst;	// @[<stdin>:815:3]
endmodule
