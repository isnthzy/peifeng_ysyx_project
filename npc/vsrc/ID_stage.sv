...
module ID_stage(	// @[<stdin>:830:3]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:830:3, playground/src/ID_stage.scala:25:28]
  assign ID_to_ex_valid = id_valid & id_ready_go;	// @[<stdin>:830:3, playground/src/ID_stage.scala:22:33, :23:33, :29:28]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:830:3, playground/src/ID_stage.scala:32:16, :142:{56,75}]
  ...
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:830:3, playground/src/ID_stage.scala:32:16, :58:50, :127:44]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:830:3, playground/src/ID_stage.scala:32:16]
  assign ID_to_ex_bits_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:830:3, playground/src/ID_stage.scala:22:33, :32:16, :130:34]
  ...
  assign ID_to_ex_bits_rdata1 = rdata1;	// @[<stdin>:830:3, playground/src/ID_stage.scala:66:28]
  assign ID_to_ex_bits_rdata2 = rdata2;	// @[<stdin>:830:3, playground/src/ID_stage.scala:67:28]
  ...
  assign ID_flush_out =
    (_J_cond_io_taken | (|_dc_io_br_type) & ~_J_cond_io_taken) & id_valid;	// @[<stdin>:830:3, playground/src/ID_stage.scala:22:33, :32:16, :105:20, :114:{14,31,38,41,59}]
  assign ID_j_cond_taken = _J_cond_io_taken & id_valid;	// @[<stdin>:830:3, playground/src/ID_stage.scala:22:33, :105:20, :109:35]
endmodule
