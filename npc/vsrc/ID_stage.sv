...
module ID_stage(	// @[<stdin>:734:3]
  ...
  output [4:0]  ID_to_ex_waddr,	// @[playground/src/ID_stage.scala:7:12]
  ...
  RegFile Regfile (	// @[playground/src/ID_stage.scala:27:21]
    ...
    .io_raddr2 (_dc_io_csr_cmd == 3'h5 ? 5'hA : ID_IO_inst[24:20]),	// @[playground/src/ID_stage.scala:12:16, :21:26, :29:{25,39}]
    .io_wen    (ID_wb_bus_wen),
    .io_rdata1 (_Regfile_io_rdata1),
    .io_rdata2 (_Regfile_io_rdata2)
  );
  assign ID_to_ex_br_type = {1'h0, _dc_io_br_type};	// @[<stdin>:734:3, playground/src/ID_stage.scala:12:16, :45:19]
  assign ID_to_ex_waddr = ID_IO_inst[11:7];	// @[<stdin>:734:3, playground/src/ID_stage.scala:24:26]
