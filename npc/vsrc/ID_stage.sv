...
module ID_stage(	// @[<stdin>:25:3]
  input  [31:0] io_inst,	// @[playground/src/ID_stage.scala:6:14]
  ...
  wire        _io_d_ebus_alu_op_0_T = IsaI_addi | IsaR_add;	// @[playground/src/ID_stage.scala:20:32, :21:32, :99:35]
  wire        _io_is_jump_T = IsaU_jal | IsaI_jalr;	// @[playground/src/ID_stage.scala:21:32, :24:32, :105:40]
  ...
  assign io_Imm = _io_Imm_output;	// @[<stdin>:25:3, playground/src/ID_stage.scala:89:43]
  assign io_is_not_jalr =
    IsaU_jal | IsaB_beq | IsaB_bne | IsaB_blt | IsaB_bltu | IsaB_bge | IsaB_bgeu;	// @[<stdin>:25:3, playground/src/ID_stage.scala:23:32, :24:32, :124:86]
  assign io_is_jump =
    _io_is_jump_T | IsaB_beq & rs1_eq_rs2 | IsaB_bne & ~rs1_eq_rs2 | IsaB_blt
    & rs1_lt_rs2_s | IsaB_bltu & rs1_lt_rs2_u | IsaB_bge & ~rs1_lt_rs2_s | IsaB_bgeu
    & ~rs1_lt_rs2_u;	// @[<stdin>:25:3, playground/src/ID_stage.scala:23:32, :105:40, :150:31, :151:38, :152:31, :155:26, :156:{26,29}, :157:26, :158:27, :159:{26,29}, :160:{15,27,30}]
  assign io_d_ebus_is_ebreak = IsaI_ebreak;	// @[<stdin>:25:3, playground/src/ID_stage.scala:21:32]
  assign io_d_ebus_data_wen =
    ...
    | IsaR_sra | IsaR_srl;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :24:32, :99:35, :103:69]
  assign io_d_ebus_result_is_imm = IsaU_lui;	// @[<stdin>:25:3, playground/src/ID_stage.scala:24:32]
  assign io_d_ebus_result_is_snpc = _io_is_jump_T;	// @[<stdin>:25:3, playground/src/ID_stage.scala:105:40]
  assign io_d_ebus_src_is_sign = _io_d_ebus_alu_op_7_T | IsaR_slt | IsaB_blt | IsaB_bltu;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :23:32, :106:{41,74}]
  assign io_d_ebus_src1_is_pc = IsaU_auipc;	// @[<stdin>:25:3, playground/src/ID_stage.scala:24:32]
  assign io_d_ebus_src2_is_imm =
    ...
    | IsaI_lhu;	// @[<stdin>:25:3, playground/src/ID_stage.scala:21:32, :22:32, :24:32, :110:76]
  assign io_d_ebus_src2_is_shamt_imm = IsaI_slli | IsaI_srai | IsaI_srli;	// @[<stdin>:25:3, playground/src/ID_stage.scala:21:32, :111:56]
  assign io_d_ebus_src2_is_shamt_src = IsaR_sll | IsaR_sra | IsaR_srl;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :112:54]
  assign io_d_ebus_snpc = io_f_dbus_snpc;	// @[<stdin>:25:3]
  assign io_d_ebus_imm = _io_Imm_output;	// @[<stdin>:25:3, playground/src/ID_stage.scala:89:43]
  assign io_d_ebus_src1 = io_inst[19:15];	// @[<stdin>:25:3, playground/src/ID_stage.scala:33:25]
  assign io_d_ebus_src2 = io_inst[24:20];	// @[<stdin>:25:3, playground/src/ID_stage.scala:32:25]
  assign io_d_ebus_rd = io_inst[11:7];	// @[<stdin>:25:3, playground/src/ID_stage.scala:28:46]
  assign io_d_ebus_alu_op_0 =
    _io_d_ebus_alu_op_0_T | IsaI_ebreak | IsaI_jalr | IsaU_auipc | IsaI_lb | IsaI_lh
    | IsaI_lw | IsaI_lbu | IsaI_lhu | IsaS_sb | IsaS_sh | IsaS_sw;	// @[<stdin>:25:3, playground/src/ID_stage.scala:21:32, :22:32, :24:32, :99:35, :127:25]
  assign io_d_ebus_alu_op_1 = IsaR_sub;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32]
  assign io_d_ebus_alu_op_2 = IsaI_andi | IsaR_and;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :131:36]
  assign io_d_ebus_alu_op_3 = IsaI_ori | IsaR_or;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :133:36]
  assign io_d_ebus_alu_op_4 = IsaI_xori | IsaR_xor;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :135:36]
  assign io_d_ebus_alu_op_5 = IsaR_slt | IsaR_sltu | IsaI_slti | IsaI_sltiu;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :137:60]
  assign io_d_ebus_alu_op_6 = IsaI_slli | IsaR_sll;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :139:36]
  assign io_d_ebus_alu_op_7 = _io_d_ebus_alu_op_7_T;	// @[<stdin>:25:3, playground/src/ID_stage.scala:106:41]
  assign io_d_ebus_alu_op_8 = IsaI_srli | IsaR_srl;	// @[<stdin>:25:3, playground/src/ID_stage.scala:20:32, :21:32, :143:36]
endmodule
