...
module ID_stage(	// @[<stdin>:810:3]
  ...
  assign ID_to_ex_bits_src1 = _dc_io_A_sel ? rdata1 : ID_IO_bits_pc;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :60:28, :80:38]
  assign ID_to_ex_bits_src2 = _dc_io_B_sel ? rdata2 : imm;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :28:25, :61:28, :84:38]
