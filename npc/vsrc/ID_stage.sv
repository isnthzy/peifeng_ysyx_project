...
module ID_stage(	// @[<stdin>:955:3]
  input         clock,	// @[<stdin>:956:11]
                reset,	// @[<stdin>:957:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:956:11]
    if (reset)	// @[<stdin>:956:11]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:955:3, playground/src/ID_stage.scala:24:28]
  assign ID_to_ex_valid = id_valid & id_ready_go;	// @[<stdin>:955:3, playground/src/ID_stage.scala:21:33, :22:33, :28:28]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:955:3, playground/src/ID_stage.scala:31:16, :165:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:955:3, playground/src/ID_stage.scala:39:30]
  assign ID_to_ex_bits_b_taken = _B_cond_io_taken & id_valid;	// @[<stdin>:955:3, playground/src/ID_stage.scala:21:33, :125:20, :144:41]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:955:3, playground/src/ID_stage.scala:31:16]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:955:3, playground/src/ID_stage.scala:31:16]
  assign ID_to_ex_bits_rf_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:955:3, playground/src/ID_stage.scala:21:33, :31:16, :153:37]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:955:3, playground/src/ID_stage.scala:37:24]
  assign ID_to_ex_bits_src1 = src1;	// @[<stdin>:955:3, playground/src/ID_stage.scala:110:38]
  assign ID_to_ex_bits_src2 = casez_tmp;	// @[<stdin>:955:3, playground/src/ID_stage.scala:114:38]
  assign ID_to_ex_bits_rdata1 = rdata1;	// @[<stdin>:955:3, playground/src/ID_stage.scala:64:28]
  assign ID_to_ex_bits_rdata2 = rdata2;	// @[<stdin>:955:3, playground/src/ID_stage.scala:65:28]
  assign ID_to_ex_bits_nextpc = ID_IO_bits_nextpc;	// @[<stdin>:955:3]
  assign ID_to_ex_bits_pc = ID_IO_bits_pc;	// @[<stdin>:955:3]
  assign ID_to_ex_bits_inst = ID_IO_bits_inst;	// @[<stdin>:955:3]
  assign ID_to_if_Br_J_taken = _J_cond_io_taken & id_valid;	// @[<stdin>:955:3, playground/src/ID_stage.scala:21:33, :124:20, :129:39]
  assign ID_to_if_flush =
    (_J_cond_io_taken | _B_cond_io_taken | _dc_io_csr_cmd == 5'h4
     | _dc_io_csr_cmd == 5'h3) & id_valid;	// @[<stdin>:955:3, playground/src/ID_stage.scala:21:33, :31:16, :56:50, :124:20, :125:20, :139:35, :140:{17,35,48}]
endmodule
