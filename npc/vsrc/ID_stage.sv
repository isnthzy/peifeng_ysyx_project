...
module ID_stage(	// @[<stdin>:830:3]
  ...
  wire        _J_cond_io_taken;	// @[playground/src/ID_stage.scala:106:20]
  ...
  wire        _dc_io_B_sel;	// @[playground/src/ID_stage.scala:33:16]
  ...
  wire [4:0]  rs2 = ID_IO_bits_inst[24:20];	// @[playground/src/ID_stage.scala:37:25, :50:25]
  wire [4:0]  rs1 = ID_IO_bits_inst[19:15];	// @[playground/src/ID_stage.scala:36:25, :51:25]
  wire [2:0]  funct3 = ID_IO_bits_inst[14:12];	// @[playground/src/ID_stage.scala:38:28, :52:28]
  wire [4:0]  rd = ID_IO_bits_inst[11:7];	// @[playground/src/ID_stage.scala:39:24, :53:24]
  wire [6:0]  opcode = ID_IO_bits_inst[6:0];	// @[playground/src/ID_stage.scala:40:28, :54:28]
  wire [11:0] csr_addr = ID_IO_bits_inst[31:20];	// @[playground/src/ID_stage.scala:41:30, :55:30]
  wire [4:0]  _Regfile_io_raddr2_T_3 =
    _dc_io_csr_cmd == 5'h4 ? 5'hF : _dc_io_csr_cmd == 5'h5 ? 5'hA : rs2;	// @[playground/src/ID_stage.scala:33:16, :37:25, :59:50]
  wire        _rdata1_T = rs1 == ID_ex_fw_addr;	// @[playground/src/ID_stage.scala:36:25, :73:38]
  wire        _rdata1_T_1 = rs1 == ID_ls_fw_addr;	// @[playground/src/ID_stage.scala:36:25, :74:37]
  wire        rs1_is_forward =
    (|rs1) & ~id_clog
    & (_rdata1_T | _rdata1_T_1 | ID_wb_bus_wen & rs1 == ID_wb_bus_waddr);	// @[playground/src/ID_stage.scala:20:29, :36:25, :69:36, :71:38, :72:{27,39}, :73:38, :74:{37,55}, :75:{34,55}]
  wire        _rdata2_T = _Regfile_io_raddr2_T_3 == ID_ex_fw_addr;	// @[playground/src/ID_stage.scala:59:50, :78:38]
  wire        _rdata2_T_1 = _Regfile_io_raddr2_T_3 == ID_ls_fw_addr;	// @[playground/src/ID_stage.scala:59:50, :79:37]
  wire        rs2_is_forward =
    (|_Regfile_io_raddr2_T_3) & ~id_clog
    & (_rdata2_T | _rdata2_T_1 | ID_wb_bus_wen
       & _Regfile_io_raddr2_T_3 == ID_wb_bus_waddr);	// @[playground/src/ID_stage.scala:20:29, :59:50, :70:36, :72:27, :76:38, :77:39, :78:38, :79:{37,55}, :80:{34,55}]
  wire [31:0] rdata1 =
    rs1_is_forward
  ...
  wire [31:0] src1 = _dc_io_A_sel ? rdata1 : ID_IO_bits_pc;	// @[playground/src/ID_stage.scala:33:16, :67:28, :93:38]
  wire [31:0] imm;	// @[playground/src/ID_stage.scala:35:25]
  wire [31:0] src2 = _dc_io_B_sel ? rdata2 : imm;	// @[playground/src/ID_stage.scala:33:16, :35:25, :68:28, :97:38]
  wire        _ID_flush_out_T = _J_cond_io_taken & id_valid;	// @[playground/src/ID_stage.scala:23:33, :106:20, :110:35]
  ...
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:830:3, playground/src/ID_stage.scala:33:16, :139:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:830:3, playground/src/ID_stage.scala:41:30]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:830:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:830:3, playground/src/ID_stage.scala:33:16, :59:50, :124:44]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:830:3, playground/src/ID_stage.scala:33:16]
  assign ID_to_ex_bits_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:830:3, playground/src/ID_stage.scala:23:33, :33:16, :127:34]
  ...
  assign ID_flush_out = _ID_flush_out_T & ~ID_flush;	// @[<stdin>:830:3, playground/src/ID_stage.scala:110:{35,48}, :112:43]
  assign ID_j_cond_taken = _ID_flush_out_T & ~ID_flush;	// @[<stdin>:830:3, playground/src/ID_stage.scala:110:{35,45,48}]
endmodule
