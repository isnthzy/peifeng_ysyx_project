...
module ID_stage(	// @[<stdin>:816:3]
  input         clock,	// @[<stdin>:817:11]
                reset,	// @[<stdin>:818:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:817:11]
    if (reset)	// @[<stdin>:817:11]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:816:3, playground/src/ID_stage.scala:17:28]
  assign ID_to_ex_valid = id_valid & id_ready_go;	// @[<stdin>:816:3, playground/src/ID_stage.scala:14:33, :15:33, :21:28]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:816:3, playground/src/ID_stage.scala:31:30]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:816:3, playground/src/ID_stage.scala:23:16]
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:816:3, playground/src/ID_stage.scala:23:16, :49:50, :75:44]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:816:3, playground/src/ID_stage.scala:29:24]
  assign ID_to_ex_bits_src1 = _dc_io_A_sel ? _Regfile_io_rdata1 : ID_IO_bits_pc;	// @[<stdin>:816:3, playground/src/ID_stage.scala:23:16, :47:21, :56:38]
  assign ID_to_ex_bits_src2 = _dc_io_B_sel ? _Regfile_io_rdata2 : imm;	// @[<stdin>:816:3, playground/src/ID_stage.scala:23:16, :25:25, :47:21, :60:38]
  assign ID_to_ex_bits_rdata1 = _Regfile_io_rdata1;	// @[<stdin>:816:3, playground/src/ID_stage.scala:47:21]
  assign ID_to_ex_bits_rdata2 = _Regfile_io_rdata2;	// @[<stdin>:816:3, playground/src/ID_stage.scala:47:21]
  assign ID_to_ex_bits_nextpc = ID_IO_bits_nextpc;	// @[<stdin>:816:3]
  assign ID_to_ex_bits_pc = ID_IO_bits_pc;	// @[<stdin>:816:3]
  assign ID_to_ex_bits_inst = ID_IO_bits_inst;	// @[<stdin>:816:3]
endmodule
