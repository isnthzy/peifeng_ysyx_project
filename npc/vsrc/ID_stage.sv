...
module ID_stage(	// @[<stdin>:862:3]
  ...
  wire        _B_cond_io_taken;	// @[playground/src/ID_stage.scala:106:20]
  ...
  wire        id_clog = ID_for_ex_clog | ID_for_ls_clog;	// @[playground/src/ID_stage.scala:19:29, :20:27]
  ...
  wire        rs1_is_forward =
    (|rs1) & ~id_clog
    & (_rdata1_T | _rdata1_T_1 | ID_wb_bus_wen & rs1 == ID_wb_bus_waddr);	// @[playground/src/ID_stage.scala:19:29, :35:25, :68:36, :70:38, :71:{27,39}, :72:38, :73:{37,55}, :74:{34,55}]
  ...
  wire        rs2_is_forward =
    ...
    & (_rdata2_T | _rdata2_T_1 | ID_wb_bus_wen
       & _Regfile_io_raddr2_T_3 == ID_wb_bus_waddr);	// @[playground/src/ID_stage.scala:19:29, :58:50, :69:36, :71:27, :75:38, :76:39, :77:38, :78:{37,55}, :79:{34,55}]
  wire [31:0] rdata1 =
    rs1_is_forward
  ...
  Br_j J_cond (	// @[playground/src/ID_stage.scala:105:20]
    ...
    .io_src1    (src1),	// @[playground/src/ID_stage.scala:92:38]
    .io_src2    (src2),	// @[playground/src/ID_stage.scala:96:38]
    .io_taken   (_J_cond_io_taken),
    .io_target  (ID_j_cond_target)
  );
  Br_b B_cond (	// @[playground/src/ID_stage.scala:106:20]
    .io_br_type (_dc_io_br_type),	// @[playground/src/ID_stage.scala:32:16]
  ...
  assign ID_IO_ready = _ID_IO_ready_output;	// @[<stdin>:862:3, playground/src/ID_stage.scala:25:28]
  assign ID_to_ex_valid = id_valid & id_ready_go;	// @[<stdin>:862:3, playground/src/ID_stage.scala:22:33, :23:33, :29:28]
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:862:3, playground/src/ID_stage.scala:32:16, :150:{56,75}]
  assign ID_to_ex_bits_csr_addr = csr_addr;	// @[<stdin>:862:3, playground/src/ID_stage.scala:40:30]
  assign ID_to_ex_bits_csr_cmd = _dc_io_csr_cmd;	// @[<stdin>:862:3, playground/src/ID_stage.scala:32:16]
  assign ID_to_ex_bits_b_taken = _B_cond_io_taken & id_valid;	// @[<stdin>:862:3, playground/src/ID_stage.scala:22:33, :106:20, :125:41]
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:862:3, playground/src/ID_stage.scala:32:16, :58:50, :135:44]
  assign ID_to_ex_bits_br_type = _dc_io_br_type;	// @[<stdin>:862:3, playground/src/ID_stage.scala:32:16]
  assign ID_to_ex_bits_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:862:3, playground/src/ID_stage.scala:22:33, :32:16, :138:34]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:862:3, playground/src/ID_stage.scala:38:24]
  assign ID_to_ex_bits_src1 = src1;	// @[<stdin>:862:3, playground/src/ID_stage.scala:92:38]
  assign ID_to_ex_bits_src2 = src2;	// @[<stdin>:862:3, playground/src/ID_stage.scala:96:38]
  assign ID_to_ex_bits_rdata2 = rdata2;	// @[<stdin>:862:3, playground/src/ID_stage.scala:67:28]
  ...
  assign ID_flush_out = (_J_cond_io_taken | _B_cond_io_taken) & id_valid;	// @[<stdin>:862:3, playground/src/ID_stage.scala:22:33, :105:20, :106:20, :120:{14,34}]
  assign ID_j_cond_taken = _J_cond_io_taken & id_valid;	// @[<stdin>:862:3, playground/src/ID_stage.scala:22:33, :105:20, :110:35]
endmodule
