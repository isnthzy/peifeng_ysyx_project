...
module ID_stage(	// @[<stdin>:810:3]
  ...
  assign ID_to_ex_bits_dpic_bundle_id_inv_flag =
    _dc_io_illegal & ID_IO_bits_nextpc != 32'h80000000;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :114:{56,75}]
  ...
  assign ID_to_ex_bits_ebreak_flag = _dc_io_csr_cmd == 5'h5;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :52:50, :99:44]
  assign ID_to_ex_bits_wen = _dc_io_wb_en & id_valid;	// @[<stdin>:810:3, playground/src/ID_stage.scala:17:33, :26:16, :102:34]
  assign ID_to_ex_bits_rd = rd;	// @[<stdin>:810:3, playground/src/ID_stage.scala:32:24]
  assign ID_to_ex_bits_src1 = _dc_io_A_sel ? _Regfile_io_rdata1 : ID_IO_bits_pc;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :50:21, :80:38]
  assign ID_to_ex_bits_src2 = _dc_io_B_sel ? _Regfile_io_rdata2 : imm;	// @[<stdin>:810:3, playground/src/ID_stage.scala:26:16, :28:25, :50:21, :84:38]
