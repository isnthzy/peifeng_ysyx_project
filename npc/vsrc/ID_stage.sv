...
module ID_stage(	// @[<stdin>:1008:3]
  ...
  assign id_clog = (ID_for_ex_clog | ID_for_ls_clog) & rs1_is_forward;	// @[playground/src/ID_stage.scala:17:29, :68:36, :70:{29,49}]
  ...
  always_comb begin	// @[playground/src/ID_stage.scala:116:38]
    casez (_dc_io_B_sel)	// @[playground/src/ID_stage.scala:33:16, :116:38]
      ...
      default:
        casez_tmp = 32'h0;	// @[playground/src/ID_stage.scala:116:38]
