...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  wire        _GEN = PreIF_ready_go | br_modify;	// @[playground/src/PreIF.scala:18:36, :21:31, :103:23]
  `ifndef SYNTHESIS	// @[playground/src/PreIF.scala:104:11]
    always @(posedge clock) begin	// @[playground/src/PreIF.scala:104:11]
      if ((`PRINTF_COND_) & _GEN & ~reset)	// @[playground/src/PreIF.scala:103:23, :104:11]
        $fwrite(32'h80000002, "PreIF: pc=%x, nextpc=%x , is_fire=%d\n", PreIF_pc,
                PreIF_nextpc, PreIF_to_if_ready & _PreIF_to_if_valid_output);	// @[playground/src/PreIF.scala:40:26, :47:29, :50:36, :104:11, src/main/scala/chisel3/util/Decoupled.scala:52:35]
    end // always @(posedge)
  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      if (_GEN)	// @[playground/src/PreIF.scala:103:23]
