...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  wire [31:0] PreIF_snpc = 32'h80000000;	// @[playground/src/PreIF.scala:37:36, :41:26]
  ...
  assign PreIF_to_if_valid = ~PreIF_flush & resetn;	// @[<stdin>:3:3, playground/src/PreIF.scala:18:28, :26:33, :29:26]
  assign PreIF_to_if_bits_nextpc = PreIF_nextpc;	// @[<stdin>:3:3, playground/src/PreIF.scala:39:36]
  assign PreIF_to_if_bits_pc = 32'h7FFFFFFC;	// @[<stdin>:3:3, playground/src/PreIF.scala:36:29]
