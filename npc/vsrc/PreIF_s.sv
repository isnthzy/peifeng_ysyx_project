...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  wire        _GEN = ReadRequstState & PreIF_ar_ready;	// @[playground/src/PreIF.scala:54:30, :61:45, :62:25, :63:22]
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      if (PreIF_to_if_ready & _PreIF_to_if_valid_output)	// @[playground/src/PreIF.scala:29:26, src/main/scala/chisel3/util/Decoupled.scala:52:35]
        PreIF_pc <= PreIF_nextpc;	// @[playground/src/PreIF.scala:36:29, :39:36]
      if (ReadRequstState) begin	// @[playground/src/PreIF.scala:54:30]
        arvalidReg <= ~_GEN & arvalidReg;	// @[playground/src/PreIF.scala:50:25, :54:30, :61:45, :62:25, :63:22, :64:17]
        ReadRequstState <= ~_GEN & ReadRequstState;	// @[playground/src/PreIF.scala:54:30, :61:45, :62:25, :63:22]
      end
  ...
  assign PreIF_to_if_bits_nextpc = 32'h0;	// @[<stdin>:3:3, playground/src/PreIF.scala:51:24]
  assign PreIF_to_if_bits_pc = PreIF_nextpc;	// @[<stdin>:3:3, playground/src/PreIF.scala:39:36]
