...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  wire        _GEN = ReadRequstState & PreIF_ar_ready;	// @[playground/src/PreIF.scala:60:30, :67:45, :68:25, :69:22]
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      if (ReadRequstState) begin	// @[playground/src/PreIF.scala:60:30]
        arvalidReg <= ~_GEN & arvalidReg;	// @[playground/src/PreIF.scala:56:25, :60:30, :67:45, :68:25, :69:22, :70:17]
        ReadRequstState <= ~_GEN & ReadRequstState;	// @[playground/src/PreIF.scala:60:30, :67:45, :68:25, :69:22]
      end
      ...
      if (~ReadRequstState & fetch_wen)	// @[playground/src/PreIF.scala:19:31, :57:24, :60:30, :61:{23,33}, :62:20, :64:16]
