...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  reg         resetnReg;	// @[playground/src/PreIF.scala:19:34]
  ...
  wire        _PreIF_to_if_valid_output = ~PreIF_flush & resetnReg;	// @[playground/src/PreIF.scala:19:34, :26:33, :29:26]
  ...
  wire        is_fire = PreIF_to_if_ready & _PreIF_to_if_valid_output;	// @[playground/src/PreIF.scala:29:26, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      resetnReg <= 1'h0;	// @[playground/src/PreIF.scala:19:34]
      PreIF_pc <= 32'h7FFFFFFC;	// @[playground/src/PreIF.scala:36:29]
      arvalidReg <= 1'h0;	// @[playground/src/PreIF.scala:19:34, :50:25]
      araddrReg <= 32'h0;	// @[playground/src/PreIF.scala:51:24]
      ReadRequstState <= 1'h0;	// @[playground/src/PreIF.scala:19:34, :54:30]
    end
    else begin	// @[<stdin>:4:11]
      resetnReg <= ~reset;	// @[playground/src/PreIF.scala:19:34, :21:15]
