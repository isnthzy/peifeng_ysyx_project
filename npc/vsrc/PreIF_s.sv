...
module PreIF_s(	// @[<stdin>:3:3]
  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      PreIF_pc <= 32'h7FFFFFFC;	// @[playground/src/PreIF.scala:33:29]
  ...
  assign PreIF_to_if_bits_nextpc = 32'h0;	// @[<stdin>:3:3, playground/src/PreIF.scala:48:24]
  assign PreIF_to_if_bits_pc = PreIF_nextpc;	// @[<stdin>:3:3, playground/src/PreIF.scala:36:36]
