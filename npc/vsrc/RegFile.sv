...
module RegFile(	// @[<stdin>:841:3]
  input         clock,	// @[<stdin>:842:11]
                reset,	// @[<stdin>:843:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:842:11]
    if (reset) begin	// @[<stdin>:842:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:841:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:841:3, playground/src/Regfile.scala:24:12]
endmodule
