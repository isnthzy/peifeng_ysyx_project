...
module RegFile(	// @[<stdin>:777:3]
  input         clock,	// @[<stdin>:778:11]
                reset,	// @[<stdin>:779:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:778:11]
    if (reset) begin	// @[<stdin>:778:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:777:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:777:3, playground/src/Regfile.scala:24:12]
endmodule
