...
module RegFile(	// @[<stdin>:764:3]
  input         clock,	// @[<stdin>:765:11]
                reset,	// @[<stdin>:766:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:765:11]
    if (reset) begin	// @[<stdin>:765:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:764:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:764:3, playground/src/Regfile.scala:24:12]
endmodule
