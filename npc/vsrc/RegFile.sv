...
module RegFile(	// @[<stdin>:749:3]
  input         clock,	// @[<stdin>:750:11]
                reset,	// @[<stdin>:751:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:750:11]
    if (reset) begin	// @[<stdin>:750:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:749:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:749:3, playground/src/Regfile.scala:24:12]
endmodule
