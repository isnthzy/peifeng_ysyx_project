...
module RegFile(	// @[<stdin>:770:3]
  input         clock,	// @[<stdin>:771:11]
                reset,	// @[<stdin>:772:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:771:11]
    if (reset) begin	// @[<stdin>:771:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:770:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:770:3, playground/src/Regfile.scala:24:12]
endmodule
