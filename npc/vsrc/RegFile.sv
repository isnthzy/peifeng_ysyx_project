...
module RegFile(	// @[<stdin>:822:3]
  input         clock,	// @[<stdin>:823:11]
                reset,	// @[<stdin>:824:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:823:11]
    if (reset) begin	// @[<stdin>:823:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:822:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:822:3, playground/src/Regfile.scala:24:12]
endmodule
