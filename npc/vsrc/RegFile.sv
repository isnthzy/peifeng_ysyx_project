...
module RegFile(	// @[<stdin>:750:3]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:750:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:750:3, playground/src/Regfile.scala:24:12]
endmodule
