...
module RegFile(	// @[<stdin>:795:3]
  input         clock,	// @[<stdin>:796:11]
                reset,	// @[<stdin>:797:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:796:11]
    if (reset) begin	// @[<stdin>:796:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:795:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:795:3, playground/src/Regfile.scala:24:12]
endmodule
