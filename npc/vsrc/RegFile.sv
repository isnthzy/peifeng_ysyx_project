...
module RegFile(	// @[<stdin>:820:3]
  input         clock,	// @[<stdin>:821:11]
                reset,	// @[<stdin>:822:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:821:11]
    if (reset) begin	// @[<stdin>:821:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:820:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:820:3, playground/src/Regfile.scala:24:12]
endmodule
