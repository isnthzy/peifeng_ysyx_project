...
module RegFile(	// @[<stdin>:760:3]
  input         clock,	// @[<stdin>:761:11]
                reset,	// @[<stdin>:762:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:761:11]
    if (reset) begin	// @[<stdin>:761:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:760:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:760:3, playground/src/Regfile.scala:24:12]
endmodule
