...
module RegFile(	// @[<stdin>:771:3]
  input         clock,	// @[<stdin>:772:11]
                reset,	// @[<stdin>:773:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:772:11]
    if (reset) begin	// @[<stdin>:772:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:771:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:771:3, playground/src/Regfile.scala:24:12]
endmodule
