...
module RegFile(	// @[<stdin>:780:3]
  input         clock,	// @[<stdin>:781:11]
                reset,	// @[<stdin>:782:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:781:11]
    if (reset) begin	// @[<stdin>:781:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:780:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:780:3, playground/src/Regfile.scala:24:12]
endmodule
