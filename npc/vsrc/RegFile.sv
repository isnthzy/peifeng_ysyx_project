...
module RegFile(	// @[<stdin>:772:3]
  input         clock,	// @[<stdin>:773:11]
                reset,	// @[<stdin>:774:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:773:11]
    if (reset) begin	// @[<stdin>:773:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:772:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:772:3, playground/src/Regfile.scala:24:12]
endmodule
