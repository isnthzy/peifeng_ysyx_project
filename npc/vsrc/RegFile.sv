...
module RegFile(	// @[<stdin>:778:3]
  input         clock,	// @[<stdin>:779:11]
                reset,	// @[<stdin>:780:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:779:11]
    if (reset) begin	// @[<stdin>:779:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:778:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:778:3, playground/src/Regfile.scala:24:12]
endmodule
