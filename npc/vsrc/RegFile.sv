...
module RegFile(	// @[<stdin>:819:3]
  input         clock,	// @[<stdin>:820:11]
                reset,	// @[<stdin>:821:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:820:11]
    if (reset) begin	// @[<stdin>:820:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:819:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:819:3, playground/src/Regfile.scala:24:12]
endmodule
