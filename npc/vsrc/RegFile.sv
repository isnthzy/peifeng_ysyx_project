...
module RegFile(	// @[<stdin>:686:3]
  input         clock,	// @[<stdin>:687:11]
                reset,	// @[<stdin>:688:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:687:11]
    if (reset) begin	// @[<stdin>:687:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:686:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:686:3, playground/src/Regfile.scala:24:12]
endmodule
