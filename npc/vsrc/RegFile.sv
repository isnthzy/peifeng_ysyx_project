...
module RegFile(	// @[<stdin>:792:3]
  input         clock,	// @[<stdin>:793:11]
                reset,	// @[<stdin>:794:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:793:11]
    if (reset) begin	// @[<stdin>:793:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:792:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:792:3, playground/src/Regfile.scala:24:12]
endmodule
