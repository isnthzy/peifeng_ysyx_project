...
module RegFile(	// @[<stdin>:766:3]
  input         clock,	// @[<stdin>:767:11]
                reset,	// @[<stdin>:768:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:767:11]
    if (reset) begin	// @[<stdin>:767:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:766:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:766:3, playground/src/Regfile.scala:24:12]
endmodule
