...
module RegFile(	// @[<stdin>:776:3]
  input         clock,	// @[<stdin>:777:11]
                reset,	// @[<stdin>:778:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:777:11]
    if (reset) begin	// @[<stdin>:777:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:776:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:776:3, playground/src/Regfile.scala:24:12]
endmodule
