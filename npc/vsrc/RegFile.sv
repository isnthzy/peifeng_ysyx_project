...
module RegFile(	// @[<stdin>:769:3]
  input         clock,	// @[<stdin>:770:11]
                reset,	// @[<stdin>:771:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:770:11]
    if (reset) begin	// @[<stdin>:770:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:769:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:769:3, playground/src/Regfile.scala:24:12]
endmodule
