...
module RegFile(	// @[<stdin>:774:3]
  input         clock,	// @[<stdin>:775:11]
                reset,	// @[<stdin>:776:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:775:11]
    if (reset) begin	// @[<stdin>:775:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:774:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:774:3, playground/src/Regfile.scala:24:12]
endmodule
