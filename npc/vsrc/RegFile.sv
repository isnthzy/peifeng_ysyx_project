...
module RegFile(	// @[<stdin>:443:3]
  ...
  assign io_rdata1 = (|io_raddr1) ? casez_tmp : 32'h0;	// @[<stdin>:443:3, playground/src/RegFile.scala:14:25, :17:{17,27}]
  assign io_rdata2 = (|io_raddr2) ? casez_tmp_0 : 32'h0;	// @[<stdin>:443:3, playground/src/RegFile.scala:14:25, :18:{17,27}]
endmodule
