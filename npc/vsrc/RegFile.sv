...
module RegFile(	// @[<stdin>:829:3]
  input         clock,	// @[<stdin>:830:11]
                reset,	// @[<stdin>:831:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:830:11]
    if (reset) begin	// @[<stdin>:830:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:829:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:829:3, playground/src/Regfile.scala:24:12]
endmodule
