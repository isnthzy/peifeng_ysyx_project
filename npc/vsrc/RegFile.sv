...
module RegFile(	// @[<stdin>:768:3]
  input         clock,	// @[<stdin>:769:11]
                reset,	// @[<stdin>:770:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:769:11]
    if (reset) begin	// @[<stdin>:769:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:768:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:768:3, playground/src/Regfile.scala:24:12]
endmodule
