...
module RegFile(	// @[<stdin>:442:3]
  input         clock,	// @[<stdin>:443:11]
                reset,	// @[<stdin>:444:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:443:11]
    if (reset) begin	// @[<stdin>:443:11]
  ...
  assign io_rdata1 = (|io_raddr1) ? casez_tmp : 32'h0;	// @[<stdin>:442:3, playground/src/RegFile.scala:14:25, :17:{17,27}]
  assign io_rdata2 = (|io_raddr2) ? casez_tmp_0 : 32'h0;	// @[<stdin>:442:3, playground/src/RegFile.scala:14:25, :18:{17,27}]
endmodule
