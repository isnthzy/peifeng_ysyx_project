...
module RegFile(	// @[<stdin>:761:3]
  ...
  always @(posedge clock) begin	// @[<stdin>:762:11]
    if (reset) begin	// @[<stdin>:762:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:761:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:761:3, playground/src/Regfile.scala:24:12]
endmodule
