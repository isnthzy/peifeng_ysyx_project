...
module RegFile(	// @[<stdin>:779:3]
  input         clock,	// @[<stdin>:780:11]
                reset,	// @[<stdin>:781:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:780:11]
    if (reset) begin	// @[<stdin>:780:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:779:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:779:3, playground/src/Regfile.scala:24:12]
endmodule
