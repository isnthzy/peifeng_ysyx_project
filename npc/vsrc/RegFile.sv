...
module RegFile(	// @[<stdin>:767:3]
  input         clock,	// @[<stdin>:768:11]
                reset,	// @[<stdin>:769:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:768:11]
    if (reset) begin	// @[<stdin>:768:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:767:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:767:3, playground/src/Regfile.scala:24:12]
endmodule
