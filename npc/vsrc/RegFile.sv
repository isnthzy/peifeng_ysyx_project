...
module RegFile(	// @[<stdin>:469:3]
  ...
  `ifndef SYNTHESIS	// @[playground/src/RegFile.scala:17:11]
    always @(posedge clock) begin	// @[playground/src/RegFile.scala:17:11]
      if ((`PRINTF_COND_) & io_wen & ~reset) begin	// @[playground/src/RegFile.scala:17:11, :18:11]
        $fwrite(32'h80000002, "waddr= %x wdata= %x\n", io_waddr,
                (|io_waddr) ? io_wdata : 32'h0);	// @[playground/src/RegFile.scala:14:25, :15:{16,25}, :17:11]
        $fwrite(32'h80000002, "rf_1 %x ,rf_2 %x\n", rf_1, rf_2);	// @[playground/src/RegFile.scala:14:17, :17:11, :18:11]
      end
    end // always @(posedge)
