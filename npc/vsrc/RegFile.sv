...
module RegFile(	// @[<stdin>:794:3]
  input         clock,	// @[<stdin>:795:11]
                reset,	// @[<stdin>:796:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:795:11]
    if (reset) begin	// @[<stdin>:795:11]
  ...
  assign io_rdata1 = casez_tmp;	// @[<stdin>:794:3, playground/src/Regfile.scala:23:12]
  assign io_rdata2 = casez_tmp_0;	// @[<stdin>:794:3, playground/src/Regfile.scala:24:12]
endmodule
