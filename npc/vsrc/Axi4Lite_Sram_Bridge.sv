...
module Axi4Lite_Sram_Bridge(	// @[<stdin>:1545:3]
  ...
  assign io_r_valid = io_ar_valid;	// @[<stdin>:1545:3]
  assign io_b_valid = io_aw_valid & io_w_valid;	// @[<stdin>:1545:3, playground/src/Sram.scala:34:19]
endmodule
