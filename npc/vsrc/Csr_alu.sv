...
module Csr_alu(	// @[<stdin>:1192:3]
  ...
  assign io_wen = io_csr_cmd == 5'h1 | io_csr_cmd == 5'h2;	// @[<stdin>:1192:3, playground/src/Csr.scala:98:23, :99:{10,23}]
  assign io_out =
    io_csr_cmd == 5'h2
      ? io_in_csr | io_in_rdata1
      : io_csr_cmd == 5'h1 ? io_in_rdata1 : 32'h0;	// @[<stdin>:1192:3, playground/src/Csr.scala:98:23, :99:23, :100:36, :102:22]
endmodule
