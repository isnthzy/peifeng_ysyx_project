...
module Axi4Lite_Sram_If(	// @[<stdin>:1615:3]
  ...
  assign io_r_valid = readDataValidReg;	// @[<stdin>:1615:3, playground/src/SramIF.scala:19:31]
  assign io_r_bits_resp = 2'h0;	// @[<stdin>:1615:3, playground/src/SramIF.scala:27:17]
  assign io_aw_ready = _io_aw_ready_output;	// @[<stdin>:1615:3]
  assign io_w_ready = _io_w_ready_output;	// @[<stdin>:1615:3]
  assign io_b_valid = writeRespValidReg;	// @[<stdin>:1615:3, playground/src/SramIF.scala:37:32]
  assign io_b_bits_resp = 2'h0;	// @[<stdin>:1615:3, playground/src/SramIF.scala:27:17]
endmodule
