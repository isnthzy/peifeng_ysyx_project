...
module Axi4Lite_Sram_If(	// @[<stdin>:1998:3]
  ...
  wire       _io_aw_ready_output = 1'h1;	// @[<stdin>:1998:3, playground/src/LSFR.scala:28:11]
  wire       _io_w_ready_output = 1'h1;	// @[<stdin>:1998:3, playground/src/LSFR.scala:28:11]
  ...
  assign io_r_valid = readDataValidReg;	// @[<stdin>:1998:3, playground/src/SramIF.scala:20:31]
  assign io_r_bits_resp = 2'h0;	// @[<stdin>:1998:3, playground/src/SramIF.scala:28:17]
  assign io_aw_ready = _io_aw_ready_output;	// @[<stdin>:1998:3]
  assign io_w_ready = _io_w_ready_output;	// @[<stdin>:1998:3]
  assign io_b_valid = writeRespValidReg;	// @[<stdin>:1998:3, playground/src/SramIF.scala:36:32]
  assign io_b_bits_resp = 2'h0;	// @[<stdin>:1998:3, playground/src/SramIF.scala:28:17]
endmodule
