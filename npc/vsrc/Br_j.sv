...
module Br_j(	// @[<stdin>:920:3]
  ...
  assign io_taken = io_br_type == 4'h7 | io_br_type == 4'h8;	// @[<stdin>:920:3, playground/src/Br_cond.scala:68:27, :69:{13,26}]
  assign io_target =
    io_br_type == 4'h8 ? {_result_T[31:1], 1'h0} : io_br_type == 4'h7 ? _result_T : 32'h0;	// @[<stdin>:920:3, playground/src/Br_cond.scala:68:27, :69:26, :71:21, :73:39, :76:{18,25}]
endmodule
