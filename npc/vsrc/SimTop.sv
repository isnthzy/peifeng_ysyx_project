...
module SimTop(	// @[<stdin>:132:3]
  ...
  wire        wen =
    ...
    | IsaR_srl;	// @[playground/src/SimTop.scala:24:26, :25:26, :28:26, :114:57]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:160:18]
    .io_op
      ({1'h0,
        ...
        1'h0,
        IsaR_sub,
        IsaI_addi | IsaR_add | IsaI_ebreak | IsaI_jalr | IsaU_auipc}),	// @[playground/src/SimTop.scala:24:26, :25:26, :27:26, :28:26, :35:15, :118:29, :127:63, :133:25, :135:25, :137:25, :139:25, :142:25, :144:25, :148:25, :166:23]
