...
module SimTop(	// @[<stdin>:2063:3]
  input         clock,	// @[<stdin>:2064:11]
                reset,	// @[<stdin>:2065:11]
  ...
  wire [2:0]  _LS_stage_LS_to_wb_bits_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:15:24]
  ...
  wire [2:0]  _EX_stage_EX_to_ls_bits_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:14:24]
  ...
  wire [1:0]  _EX_stage_EX_to_ls_bits_addr_low2bit;	// @[playground/src/SimTop.scala:14:24]
  ...
  wire [2:0]  _ID_stage_ID_to_ex_bits_st_type;	// @[playground/src/SimTop.scala:13:24]
  ...
  reg  [31:0] IF_stage_IF_IO_bits_r_nextpc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] IF_stage_IF_IO_bits_r_pc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] ID_stage_ID_IO_bits_r_nextpc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] ID_stage_ID_IO_bits_r_pc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] ID_stage_ID_IO_bits_r_inst;	// @[playground/src/SimTop.scala:73:27]
  reg         EX_stage_EX_IO_bits_r_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:73:27]
  reg         EX_stage_EX_IO_bits_r_pc_sel;	// @[playground/src/SimTop.scala:73:27]
  reg  [11:0] EX_stage_EX_IO_bits_r_csr_addr;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_csr_global_mtvec;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_csr_global_mepc;	// @[playground/src/SimTop.scala:73:27]
  reg         EX_stage_EX_IO_bits_r_b_taken;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  EX_stage_EX_IO_bits_r_st_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  EX_stage_EX_IO_bits_r_ld_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  EX_stage_EX_IO_bits_r_csr_cmd;	// @[playground/src/SimTop.scala:73:27]
  reg  [1:0]  EX_stage_EX_IO_bits_r_wb_sel;	// @[playground/src/SimTop.scala:73:27]
  reg  [3:0]  EX_stage_EX_IO_bits_r_br_type;	// @[playground/src/SimTop.scala:73:27]
  reg         EX_stage_EX_IO_bits_r_rf_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  EX_stage_EX_IO_bits_r_rd;	// @[playground/src/SimTop.scala:73:27]
  reg  [3:0]  EX_stage_EX_IO_bits_r_alu_op;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_src1;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_src2;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_rdata1;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_rdata2;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_nextpc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_pc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] EX_stage_EX_IO_bits_r_inst;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_csr_commit_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [11:0] LS_stage_LS_IO_bits_r_csr_commit_waddr;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_csr_commit_wdata;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_csr_commit_exception_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_csr_commit_exception_pc_wb;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_dpic_bundle_ex_func_flag;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_jal;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_ret;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_rd0;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  LS_stage_LS_IO_bits_r_dpic_bundle_ex_ld_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_dpic_bundle_ex_mem_addr;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_data;	// @[playground/src/SimTop.scala:73:27]
  reg  [1:0]  LS_stage_LS_IO_bits_r_addr_low2bit;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_ld_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  LS_stage_LS_IO_bits_r_ld_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  LS_stage_LS_IO_bits_r_csr_cmd;	// @[playground/src/SimTop.scala:73:27]
  reg  [1:0]  LS_stage_LS_IO_bits_r_wb_sel;	// @[playground/src/SimTop.scala:73:27]
  reg         LS_stage_LS_IO_bits_r_rf_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  LS_stage_LS_IO_bits_r_rd;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_result;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_nextpc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_pc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] LS_stage_LS_IO_bits_r_inst;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_csr_commit_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [11:0] WB_stage_WB_IO_bits_r_csr_commit_waddr;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_csr_commit_wdata;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_csr_commit_exception_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [3:0]  WB_stage_WB_IO_bits_r_csr_commit_exception_mcause_in;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_csr_commit_exception_pc_wb;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_dpic_bundle_ex_func_flag;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_jal;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_ret;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_rd0;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  WB_stage_WB_IO_bits_r_dpic_bundle_ex_ld_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [2:0]  WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_dpic_bundle_ex_mem_addr;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_data;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_dpic_bundle_ls_ld_data;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  WB_stage_WB_IO_bits_r_csr_cmd;	// @[playground/src/SimTop.scala:73:27]
  reg         WB_stage_WB_IO_bits_r_rf_wen;	// @[playground/src/SimTop.scala:73:27]
  reg  [4:0]  WB_stage_WB_IO_bits_r_rd;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_result;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_nextpc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_pc;	// @[playground/src/SimTop.scala:73:27]
  reg  [31:0] WB_stage_WB_IO_bits_r_inst;	// @[playground/src/SimTop.scala:73:27]
  always @(posedge clock) begin	// @[<stdin>:2064:11]
    if (_IF_stage_IF_IO_ready & _PreIF_s_PreIF_to_if_valid) begin	// @[playground/src/SimTop.scala:11:24, :12:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      IF_stage_IF_IO_bits_r_nextpc <= _PreIF_s_PreIF_to_if_bits_nextpc;	// @[playground/src/SimTop.scala:11:24, :73:27]
      IF_stage_IF_IO_bits_r_pc <= _PreIF_s_PreIF_to_if_bits_pc;	// @[playground/src/SimTop.scala:11:24, :73:27]
    end
    if (_ID_stage_ID_IO_ready & _IF_stage_IF_to_id_valid) begin	// @[playground/src/SimTop.scala:12:24, :13:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ID_stage_ID_IO_bits_r_nextpc <= _IF_stage_IF_to_id_bits_nextpc;	// @[playground/src/SimTop.scala:12:24, :73:27]
      ID_stage_ID_IO_bits_r_pc <= _IF_stage_IF_to_id_bits_pc;	// @[playground/src/SimTop.scala:12:24, :73:27]
      ID_stage_ID_IO_bits_r_inst <= _IF_stage_IF_to_id_bits_inst;	// @[playground/src/SimTop.scala:12:24, :73:27]
    end
    if (_EX_stage_EX_IO_ready & _ID_stage_ID_to_ex_valid) begin	// @[playground/src/SimTop.scala:13:24, :14:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      EX_stage_EX_IO_bits_r_dpic_bundle_id_inv_flag <=
        _ID_stage_ID_to_ex_bits_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_pc_sel <= _ID_stage_ID_to_ex_bits_pc_sel;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_csr_addr <= _ID_stage_ID_to_ex_bits_csr_addr;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_csr_global_mtvec <= _ID_stage_ID_to_ex_bits_csr_global_mtvec;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_csr_global_mepc <= _ID_stage_ID_to_ex_bits_csr_global_mepc;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_b_taken <= _ID_stage_ID_to_ex_bits_b_taken;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_st_type <= _ID_stage_ID_to_ex_bits_st_type;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_ld_type <= _ID_stage_ID_to_ex_bits_ld_type;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_csr_cmd <= _ID_stage_ID_to_ex_bits_csr_cmd;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_wb_sel <= _ID_stage_ID_to_ex_bits_wb_sel;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_br_type <= _ID_stage_ID_to_ex_bits_br_type;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_rf_wen <= _ID_stage_ID_to_ex_bits_rf_wen;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_rd <= _ID_stage_ID_to_ex_bits_rd;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_alu_op <= _ID_stage_ID_to_ex_bits_alu_op;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_src1 <= _ID_stage_ID_to_ex_bits_src1;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_src2 <= _ID_stage_ID_to_ex_bits_src2;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_rdata1 <= _ID_stage_ID_to_ex_bits_rdata1;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_rdata2 <= _ID_stage_ID_to_ex_bits_rdata2;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_nextpc <= _ID_stage_ID_to_ex_bits_nextpc;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_pc <= _ID_stage_ID_to_ex_bits_pc;	// @[playground/src/SimTop.scala:13:24, :73:27]
      EX_stage_EX_IO_bits_r_inst <= _ID_stage_ID_to_ex_bits_inst;	// @[playground/src/SimTop.scala:13:24, :73:27]
    end
    if (_LS_stage_LS_IO_ready & _EX_stage_EX_to_ls_valid) begin	// @[playground/src/SimTop.scala:14:24, :15:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      LS_stage_LS_IO_bits_r_csr_commit_wen <= _EX_stage_EX_to_ls_bits_csr_commit_wen;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_csr_commit_waddr <= _EX_stage_EX_to_ls_bits_csr_commit_waddr;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_csr_commit_wdata <= _EX_stage_EX_to_ls_bits_csr_commit_wdata;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_csr_commit_exception_wen <=
        _EX_stage_EX_to_ls_bits_csr_commit_exception_wen;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_csr_commit_exception_pc_wb <=
        _EX_stage_EX_to_ls_bits_csr_commit_exception_pc_wb;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_id_inv_flag <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_func_flag <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_func_flag;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_jal <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_is_jal;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_ret <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_is_ret;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_rd0 <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_is_rd0;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_ld_type <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_ld_type;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_type <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_mem_addr <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_mem_addr;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_data <=
        _EX_stage_EX_to_ls_bits_dpic_bundle_ex_st_data;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_addr_low2bit <= _EX_stage_EX_to_ls_bits_addr_low2bit;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_ld_wen <= _EX_stage_EX_to_ls_bits_ld_wen;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_ld_type <= _EX_stage_EX_to_ls_bits_ld_type;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_csr_cmd <= _EX_stage_EX_to_ls_bits_csr_cmd;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_wb_sel <= _EX_stage_EX_to_ls_bits_wb_sel;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_rf_wen <= _EX_stage_EX_to_ls_bits_rf_wen;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_rd <= _EX_stage_EX_to_ls_bits_rd;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_result <= _EX_stage_EX_to_ls_bits_result;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_nextpc <= _EX_stage_EX_to_ls_bits_nextpc;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_pc <= _EX_stage_EX_to_ls_bits_pc;	// @[playground/src/SimTop.scala:14:24, :73:27]
      LS_stage_LS_IO_bits_r_inst <= _EX_stage_EX_to_ls_bits_inst;	// @[playground/src/SimTop.scala:14:24, :73:27]
    end
    if (_WB_stage_WB_IO_ready & _LS_stage_LS_to_wb_valid) begin	// @[playground/src/SimTop.scala:15:24, :16:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      WB_stage_WB_IO_bits_r_csr_commit_wen <= _LS_stage_LS_to_wb_bits_csr_commit_wen;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_commit_waddr <= _LS_stage_LS_to_wb_bits_csr_commit_waddr;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_commit_wdata <= _LS_stage_LS_to_wb_bits_csr_commit_wdata;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_commit_exception_wen <=
        _LS_stage_LS_to_wb_bits_csr_commit_exception_wen;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_commit_exception_mcause_in <=
        _LS_stage_LS_to_wb_bits_csr_commit_exception_mcause_in;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_commit_exception_pc_wb <=
        _LS_stage_LS_to_wb_bits_csr_commit_exception_pc_wb;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_id_inv_flag <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_id_inv_flag;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_func_flag <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_func_flag;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_jal <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_is_jal;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_ret <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_is_ret;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_rd0 <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_is_rd0;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_ld_type <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_ld_type;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_type <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_mem_addr <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_mem_addr;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_data <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ex_st_data;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_dpic_bundle_ls_ld_data <=
        _LS_stage_LS_to_wb_bits_dpic_bundle_ls_ld_data;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_csr_cmd <= _LS_stage_LS_to_wb_bits_csr_cmd;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_rf_wen <= _LS_stage_LS_to_wb_bits_rf_wen;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_rd <= _LS_stage_LS_to_wb_bits_rd;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_result <= _LS_stage_LS_to_wb_bits_result;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_nextpc <= _LS_stage_LS_to_wb_bits_nextpc;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_pc <= _LS_stage_LS_to_wb_bits_pc;	// @[playground/src/SimTop.scala:15:24, :73:27]
      WB_stage_WB_IO_bits_r_inst <= _LS_stage_LS_to_wb_bits_inst;	// @[playground/src/SimTop.scala:15:24, :73:27]
    end
  end // always @(posedge)
  ...
  IF_stage IF_stage (	// @[playground/src/SimTop.scala:12:24]
    ...
    .IF_IO_bits_nextpc    (IF_stage_IF_IO_bits_r_nextpc),	// @[playground/src/SimTop.scala:73:27]
    .IF_IO_bits_pc        (IF_stage_IF_IO_bits_r_pc),	// @[playground/src/SimTop.scala:73:27]
  ...
  ID_stage ID_stage (	// @[playground/src/SimTop.scala:13:24]
    ...
    .ID_IO_bits_nextpc                     (ID_stage_ID_IO_bits_r_nextpc),	// @[playground/src/SimTop.scala:73:27]
    .ID_IO_bits_pc                         (ID_stage_ID_IO_bits_r_pc),	// @[playground/src/SimTop.scala:73:27]
    .ID_IO_bits_inst                       (ID_stage_ID_IO_bits_r_inst),	// @[playground/src/SimTop.scala:73:27]
  ...
  EX_stage EX_stage (	// @[playground/src/SimTop.scala:14:24]
    ...
    .EX_IO_bits_dpic_bundle_id_inv_flag
      (EX_stage_EX_IO_bits_r_dpic_bundle_id_inv_flag),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_pc_sel                        (EX_stage_EX_IO_bits_r_pc_sel),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_csr_addr                      (EX_stage_EX_IO_bits_r_csr_addr),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_csr_global_mtvec              (EX_stage_EX_IO_bits_r_csr_global_mtvec),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_csr_global_mepc               (EX_stage_EX_IO_bits_r_csr_global_mepc),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_b_taken                       (EX_stage_EX_IO_bits_r_b_taken),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_st_type                       (EX_stage_EX_IO_bits_r_st_type),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_ld_type                       (EX_stage_EX_IO_bits_r_ld_type),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_csr_cmd                       (EX_stage_EX_IO_bits_r_csr_cmd),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_wb_sel                        (EX_stage_EX_IO_bits_r_wb_sel),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_br_type                       (EX_stage_EX_IO_bits_r_br_type),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_rf_wen                        (EX_stage_EX_IO_bits_r_rf_wen),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_rd                            (EX_stage_EX_IO_bits_r_rd),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_alu_op                        (EX_stage_EX_IO_bits_r_alu_op),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_src1                          (EX_stage_EX_IO_bits_r_src1),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_src2                          (EX_stage_EX_IO_bits_r_src2),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_rdata1                        (EX_stage_EX_IO_bits_r_rdata1),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_rdata2                        (EX_stage_EX_IO_bits_r_rdata2),	// @[playground/src/SimTop.scala:73:27]
    .EX_IO_bits_nextpc                        (EX_stage_EX_IO_bits_r_nextpc),	// @[playground/src/SimTop.scala:73:27]
  ...
  LS_stage LS_stage (	// @[playground/src/SimTop.scala:15:24]
    ...
    .LS_IO_bits_csr_commit_wen                    (LS_stage_LS_IO_bits_r_csr_commit_wen),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_csr_commit_waddr
      (LS_stage_LS_IO_bits_r_csr_commit_waddr),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_csr_commit_wdata
      (LS_stage_LS_IO_bits_r_csr_commit_wdata),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_csr_commit_exception_wen
      (LS_stage_LS_IO_bits_r_csr_commit_exception_wen),	// @[playground/src/SimTop.scala:73:27]
    ...
    .LS_IO_bits_csr_commit_exception_pc_wb
      (LS_stage_LS_IO_bits_r_csr_commit_exception_pc_wb),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_id_inv_flag
      (LS_stage_LS_IO_bits_r_dpic_bundle_id_inv_flag),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_func_flag
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_func_flag),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_is_jal
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_jal),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_is_ret
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_ret),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_is_rd0
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_is_rd0),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_ld_type
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_ld_type),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_st_type
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_type),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_mem_addr
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_mem_addr),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_dpic_bundle_ex_st_data
      (LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_data),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_addr_low2bit                      (LS_stage_LS_IO_bits_r_addr_low2bit),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_ld_wen                            (LS_stage_LS_IO_bits_r_ld_wen),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_ld_type                           (LS_stage_LS_IO_bits_r_ld_type),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_csr_cmd                           (LS_stage_LS_IO_bits_r_csr_cmd),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_wb_sel                            (LS_stage_LS_IO_bits_r_wb_sel),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_rf_wen                            (LS_stage_LS_IO_bits_r_rf_wen),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_rd                                (LS_stage_LS_IO_bits_r_rd),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_result                            (LS_stage_LS_IO_bits_r_result),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_nextpc                            (LS_stage_LS_IO_bits_r_nextpc),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_pc                                (LS_stage_LS_IO_bits_r_pc),	// @[playground/src/SimTop.scala:73:27]
    .LS_IO_bits_inst                              (LS_stage_LS_IO_bits_r_inst),	// @[playground/src/SimTop.scala:73:27]
  ...
  WB_stage WB_stage (	// @[playground/src/SimTop.scala:16:24]
    ...
    .WB_IO_bits_csr_commit_wen                 (WB_stage_WB_IO_bits_r_csr_commit_wen),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_commit_waddr               (WB_stage_WB_IO_bits_r_csr_commit_waddr),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_commit_wdata               (WB_stage_WB_IO_bits_r_csr_commit_wdata),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_commit_exception_wen
      (WB_stage_WB_IO_bits_r_csr_commit_exception_wen),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_commit_exception_mcause_in
      (WB_stage_WB_IO_bits_r_csr_commit_exception_mcause_in),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_commit_exception_pc_wb
      (WB_stage_WB_IO_bits_r_csr_commit_exception_pc_wb),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_id_inv_flag
      (WB_stage_WB_IO_bits_r_dpic_bundle_id_inv_flag),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_func_flag
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_func_flag),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_is_jal
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_jal),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_is_ret
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_ret),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_is_rd0
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_is_rd0),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_ld_type
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_ld_type),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_st_type
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_type),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_mem_addr
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_mem_addr),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ex_st_data
      (WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_data),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_dpic_bundle_ls_ld_data
      (WB_stage_WB_IO_bits_r_dpic_bundle_ls_ld_data),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_csr_cmd                        (WB_stage_WB_IO_bits_r_csr_cmd),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_rf_wen                         (WB_stage_WB_IO_bits_r_rf_wen),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_rd                             (WB_stage_WB_IO_bits_r_rd),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_result                         (WB_stage_WB_IO_bits_r_result),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_nextpc                         (WB_stage_WB_IO_bits_r_nextpc),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_pc                             (WB_stage_WB_IO_bits_r_pc),	// @[playground/src/SimTop.scala:73:27]
    .WB_IO_bits_inst                           (WB_stage_WB_IO_bits_r_inst),	// @[playground/src/SimTop.scala:73:27]
