...
module SimTop(	// @[<stdin>:2058:3]
  input         clock,	// @[<stdin>:2059:11]
                reset,	// @[<stdin>:2060:11]
  ...
  reg  [2:0]  EX_stage_EX_IO_bits_r_st_type;	// @[playground/src/SimTop.scala:72:27]
  ...
  reg  [2:0]  LS_stage_LS_IO_bits_r_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:72:27]
  ...
  reg  [1:0]  LS_stage_LS_IO_bits_r_addr_low2bit;	// @[playground/src/SimTop.scala:72:27]
  ...
  reg  [2:0]  WB_stage_WB_IO_bits_r_dpic_bundle_ex_st_type;	// @[playground/src/SimTop.scala:72:27]
  ...
  always @(posedge clock) begin	// @[<stdin>:2059:11]
    ...
    if (_LS_stage_LS_IO_ready & _EX_stage_EX_to_ls_valid) begin	// @[playground/src/SimTop.scala:14:24, :15:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ...
      LS_stage_LS_IO_bits_r_addr_low2bit <= _EX_stage_EX_to_ls_bits_addr_low2bit;	// @[playground/src/SimTop.scala:14:24, :72:27]
  ...
  LS_stage LS_stage (	// @[playground/src/SimTop.scala:15:24]
    ...
    .LS_IO_bits_addr_low2bit                      (LS_stage_LS_IO_bits_r_addr_low2bit),	// @[playground/src/SimTop.scala:72:27]
