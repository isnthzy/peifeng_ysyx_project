...
module SimTop(	// @[<stdin>:1701:3]
  ...
  always @(posedge clock) begin	// @[<stdin>:1702:11]
    if (_IF_stage_IF_IO_ready & _PreIF_s_PreIF_to_if_valid)	// @[playground/src/SimTop.scala:11:24, :12:24, src/main/scala/chisel3/util/Decoupled.scala:52:35]
