...
module SimTop(	// @[<stdin>:125:3]
  ...
  wire [31:0] snpc = REGpc + 32'h4;	// @[playground/src/SimTop.scala:17:26, :30:20, :32:14]
  ...
  wire [31:0] dnpc = IsaU_jal ? REGpc + Imm : IsaI_jalr ? jalr_taget : snpc;	// @[playground/src/SimTop.scala:15:32, :17:26, :18:26, :24:26, :27:26, :30:20, :33:{12,27}, :34:14, :100:39]
  wire        is_jump;	// @[playground/src/SimTop.scala:21:29]
  wire [31:0] nextpc = is_jump ? dnpc : snpc;	// @[playground/src/SimTop.scala:16:28, :17:26, :18:26, :21:29, :35:14]
      ...
      : _Imm_T == 5'h2
          ...
          : _Imm_T == 5'h4
              ...
              : _Imm_T == 5'h8
                  ...
                  : _Imm_T == 5'h10 ? {{20{io_inst[31]}}, io_inst[31:20]} : 32'h0;	// @[playground/src/Bundle.scala:76:{10,15,37}, playground/src/SimTop.scala:35:15, :41:23, :42:{27,42}, :43:{39,50,65}, :44:{19,27}, :45:{39,54,66}, :100:{28,39}]
  ...
  assign jalr_taget = {_jalr_tmp_T[31:1], 1'h0};	// @[playground/src/SimTop.scala:15:32, :35:15, :183:29, :184:{18,27}]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:158:18]
    .io_op
      ({1'h0,
        ...
        1'h0,
        IsaR_sub,
        _alu_op_0_T | IsaI_ebreak | IsaI_jalr}),	// @[playground/src/SimTop.scala:23:26, :24:26, :26:26, :35:15, :108:22, :116:29, :125:51, :131:25, :133:25, :135:25, :137:25, :140:25, :142:25, :146:25, :164:23]
