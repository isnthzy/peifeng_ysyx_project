...
module SimTop(	// @[<stdin>:918:3]
  input         clock,	// @[<stdin>:919:11]
                reset,	// @[<stdin>:920:11]
  ...
  wire [4:0]  _LS_stage_LS_to_wb_waddr;	// @[playground/src/SimTop.scala:35:24]
  ...
  wire [4:0]  _EX_stage_EX_to_ls_waddr;	// @[playground/src/SimTop.scala:34:24]
  ...
  wire [4:0]  _ID_stage_ID_to_ex_waddr;	// @[playground/src/SimTop.scala:33:24]
  ...
  ID_stage ID_stage (	// @[playground/src/SimTop.scala:33:24]
    ...
    .ID_to_ex_waddr   (_ID_stage_ID_to_ex_waddr),
  ...
  EX_stage EX_stage (	// @[playground/src/SimTop.scala:34:24]
    ...
    .EX_IO_waddr       (_ID_stage_ID_to_ex_waddr),	// @[playground/src/SimTop.scala:33:24]
    ...
    .EX_to_ls_waddr    (_EX_stage_EX_to_ls_waddr),
  ...
  LS_stage LS_stage (	// @[playground/src/SimTop.scala:35:24]
    ...
    .LS_IO_waddr     (_EX_stage_EX_to_ls_waddr),	// @[playground/src/SimTop.scala:34:24]
    ...
    .LS_to_wb_waddr  (_LS_stage_LS_to_wb_waddr),
  ...
  WB_stage WB_stage (	// @[playground/src/SimTop.scala:36:24]
    ...
    .WB_IO_waddr    (_LS_stage_LS_to_wb_waddr),	// @[playground/src/SimTop.scala:35:24]
