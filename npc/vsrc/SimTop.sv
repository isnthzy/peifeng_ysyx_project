...
module SimTop(	// @[<stdin>:132:3]
  ...
  wire        _alu_op_0_T = IsaI_addi | IsaR_add;	// @[playground/src/SimTop.scala:24:26, :25:26, :110:22]
  wire        wen =
    ...
    | IsaR_srl;	// @[playground/src/SimTop.scala:24:26, :25:26, :28:26, :110:22, :114:57]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:160:18]
    .io_op
      ({1'h0,
        ...
        1'h0,
        IsaR_sub,
        _alu_op_0_T | IsaI_ebreak | IsaI_jalr | IsaU_auipc}),	// @[playground/src/SimTop.scala:24:26, :25:26, :27:26, :28:26, :35:15, :110:22, :118:29, :127:63, :133:25, :135:25, :137:25, :139:25, :142:25, :144:25, :148:25, :166:23]
  ...
  assign io_pc = REGpc;	// @[<stdin>:132:3, playground/src/SimTop.scala:31:20]
  assign io_nextpc = nextpc;	// @[<stdin>:132:3, playground/src/SimTop.scala:17:28]
  assign io_result = _io_result_output;	// @[<stdin>:132:3, playground/src/SimTop.scala:183:17]
  assign io_wen = wen;	// @[<stdin>:132:3, playground/src/SimTop.scala:114:57]
  assign io_imm = Imm;	// @[<stdin>:132:3, playground/src/SimTop.scala:102:39]
endmodule
