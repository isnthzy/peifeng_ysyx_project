...
module SimTop(	// @[<stdin>:639:3]
  ...
  `ifndef SYNTHESIS	// @[playground/src/SimTop.scala:51:9]
    always @(posedge clock) begin	// @[playground/src/SimTop.scala:51:9]
      if ((`PRINTF_COND_) & ~reset)	// @[playground/src/SimTop.scala:51:9]
