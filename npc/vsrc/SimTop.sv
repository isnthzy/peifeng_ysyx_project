...
module SimTop(	// @[<stdin>:1711:3]
  input         clock,	// @[<stdin>:1712:11]
                reset,	// @[<stdin>:1713:11]
  ...
  wire        _EX_stage_EX_to_preif_epc_nextpc_stall;	// @[playground/src/SimTop.scala:14:24]
  ...
  wire        _EX_stage_EX_to_preif_Br_B_nextpc_stall;	// @[playground/src/SimTop.scala:14:24]
  ...
  wire        _ID_stage_ID_to_preif_Br_J_nextpc_stall;	// @[playground/src/SimTop.scala:13:24]
  ...
  always @(posedge clock) begin	// @[<stdin>:1712:11]
  ...
  PreIF_s PreIF_s (	// @[playground/src/SimTop.scala:11:24]
    ...
    .PreIF_for_id_Br_J_nextpc_stall (_ID_stage_ID_to_preif_Br_J_nextpc_stall),	// @[playground/src/SimTop.scala:13:24]
    ...
    .PreIF_for_ex_epc_nextpc_stall  (_EX_stage_EX_to_preif_epc_nextpc_stall),	// @[playground/src/SimTop.scala:14:24]
    ...
    .PreIF_for_ex_Br_B_nextpc_stall (_EX_stage_EX_to_preif_Br_B_nextpc_stall),	// @[playground/src/SimTop.scala:14:24]
  ...
  ID_stage ID_stage (	// @[playground/src/SimTop.scala:13:24]
    ...
    .ID_to_preif_Br_J_nextpc_stall         (_ID_stage_ID_to_preif_Br_J_nextpc_stall),
  ...
  EX_stage EX_stage (	// @[playground/src/SimTop.scala:14:24]
    ...
    .EX_to_preif_epc_nextpc_stall             (_EX_stage_EX_to_preif_epc_nextpc_stall),
    .EX_to_preif_epc_taken                    (_EX_stage_EX_to_preif_epc_taken),
    .EX_to_preif_epc_target                   (_EX_stage_EX_to_preif_epc_target),
    .EX_to_preif_Br_B_nextpc_stall            (_EX_stage_EX_to_preif_Br_B_nextpc_stall),
