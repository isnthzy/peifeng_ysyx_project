...
module SimTop(	// @[<stdin>:670:3]
  input         clock,	// @[<stdin>:671:11]
                reset,	// @[<stdin>:672:11]
  output [31:0] io_result	// @[playground/src/SimTop.scala:6:14]
);

  wire [31:0] jalr_taget;	// @[playground/src/SimTop.scala:17:35]
  wire        is_jump;	// @[playground/src/SimTop.scala:16:35]
  wire        is_not_jalr;	// @[playground/src/SimTop.scala:15:35]
  wire [31:0] Imm;	// @[playground/src/SimTop.scala:11:35]
  wire [31:0] inst;	// @[playground/src/SimTop.scala:14:35]
  ...
  ID_stage ID_stage (	// @[playground/src/SimTop.scala:29:24]
    ...
    .io_inst                     (inst),	// @[playground/src/SimTop.scala:14:35]
  ...
  assign io_result = _EXE_stage_io_result;	// @[<stdin>:670:3, playground/src/SimTop.scala:41:25]
endmodule
