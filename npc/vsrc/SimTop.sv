...
module SimTop(	// @[<stdin>:130:3]
  ...
  wire        wen =
    IsaR_add | IsaI_andi | IsaR_and | IsaU_lui | IsaR_slt | IsaR_sltu | IsaR_sub
    ...
    | IsaR_srl;	// @[playground/src/SimTop.scala:23:26, :24:26, :27:26, :112:57]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:158:18]
    .io_op
      ({1'h0,
        ...
        1'h0,
        IsaR_sub,
        IsaI_addi | IsaR_add | IsaI_ebreak | IsaI_jalr}),	// @[playground/src/SimTop.scala:23:26, :24:26, :26:26, :34:15, :116:29, :125:51, :131:25, :133:25, :135:25, :137:25, :140:25, :142:25, :146:25, :164:23]
  ...
  singal_dpi singal_dpi (	// @[playground/src/SimTop.scala:187:24]
    ...
    .inst        (io_inst),
    .rd          ({27'h0, io_inst[11:7]}),	// @[playground/src/SimTop.scala:42:42, :53:24, :193:19]
    .is_jal      (IsaU_jal),	// @[playground/src/SimTop.scala:27:26]
    .func_flag   (result_is_snpc),	// @[playground/src/SimTop.scala:115:31]
  ...
  assign io_pc = REGpc;	// @[<stdin>:130:3, playground/src/SimTop.scala:30:20]
  assign io_result = _io_result_output;	// @[<stdin>:130:3, playground/src/SimTop.scala:181:17]
  assign io_wen = wen;	// @[<stdin>:130:3, playground/src/SimTop.scala:112:57]
  assign io_imm = Imm;	// @[<stdin>:130:3, playground/src/SimTop.scala:100:39]
endmodule
