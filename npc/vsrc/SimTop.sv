...
module SimTop(	// @[<stdin>:140:3]
  ...
  wire        IsaI_ebreak = io_inst == 32'h100073;	// @[playground/src/SimTop.scala:23:26, :27:28, :96:24]
  wire [4:0]  _Imm_T =
    {|{IsaI_jalr,
       IsaI_lb,
       IsaI_lh,
      ...
      : _Imm_T == 5'h2
          ...
          : _Imm_T == 5'h4
              ...
              : _Imm_T == 5'h8
                  ...
                  : _Imm_T == 5'h10 ? {{20{io_inst[31]}}, io_inst[31:20]} : 32'h0;	// @[playground/src/Bundle.scala:76:{10,15,37}, playground/src/SimTop.scala:19:19, :27:28, :46:23, :47:{27,42}, :48:{39,50,65}, :49:{19,27}, :50:{39,54,66}, :105:{28,39}]
  ...
  assign jalr_taget = {_jalr_tmp_T[31:1], 1'h0};	// @[playground/src/SimTop.scala:14:32, :19:19, :188:29, :189:{18,27}]
  always @(posedge clock) begin	// @[<stdin>:141:11]
    Inst_inv <=
      ...
      & {IsaU_lui, IsaU_auipc, IsaU_jal} == 3'h0;	// @[playground/src/SimTop.scala:19:19, :22:26, :23:26, :24:26, :25:26, :26:26, :95:{22,28,42,48,62,68,82,88,95,102,108}]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:163:18]
    .io_op
      ({1'h0,
        ...
        1'h0,
        IsaR_sub,
        _alu_op_0_T | IsaI_ebreak | IsaI_jalr | IsaU_auipc}),	// @[playground/src/SimTop.scala:19:19, :22:26, :23:26, :25:26, :26:26, :113:22, :121:29, :130:63, :136:25, :138:25, :140:25, :142:25, :145:25, :147:25, :151:25, :169:23]
