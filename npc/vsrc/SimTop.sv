...
module SimTop(	// @[<stdin>:124:3]
  ...
  wire [4:0]  _Imm_T =
    {|{IsaI_jalr,
     ...
     ImmType_ImmJType};	// @[playground/src/SimTop.scala:50:24, :51:24, :52:24, :53:24, :54:24, :55:24, :56:24, :57:24, :58:24, :59:24, :60:24, :61:24, :62:24, :63:24, :64:24, :65:24, :66:24, :67:24, :68:24, :69:24, :70:24, :71:24, :72:24, :73:24, :74:24, :75:24, :76:24, :89:24, :93:{30,36}, :94:{30,36}, :95:{30,36}, :96:{30,36}, :98:28]
  assign Imm =
    _Imm_T == 5'h3
  ...
  wire        wen =
    ...
    | IsaI_slli | IsaI_srai | IsaI_srli | IsaR_sll | IsaR_sra | IsaR_srl;	// @[playground/src/SimTop.scala:50:24, :51:24, :69:24, :70:24, :71:24, :72:24, :73:24, :74:24, :75:24, :76:24, :78:24, :79:24, :80:24, :81:24, :82:24, :83:24, :84:24, :85:24, :86:24, :106:22, :110:57]
  wire        alu_op_9 = IsaI_srai | IsaR_sra;	// @[playground/src/SimTop.scala:76:24, :84:24, :114:29]
  wire [31:0] _io_result_output =
    IsaU_lui
      ? Imm
      : ImmType_ImmJType | IsaI_jalr ? (IsaI_jalr ? 32'h0 : _dnpc_T_4) : _alu_io_result;	// @[playground/src/SimTop.scala:27:{15,29,34}, :50:24, :52:24, :53:24, :98:39, :113:31, :156:18, :178:17, :179:18]
  always @(posedge clock) begin	// @[<stdin>:125:11]
    if (reset)	// @[<stdin>:125:11]
      pc <= 32'h7FFFFFFC;	// @[playground/src/SimTop.scala:26:17]
             ...
             & ~(_alu_io_result[0])) begin	// @[playground/src/SimTop.scala:52:24, :54:24, :55:24, :56:24, :57:24, :58:24, :59:24, :156:18, :168:{24,41}, :169:{24,27}, :170:24, :171:24, :172:{24,27}, :173:{13,24,27}]
  ...
  Alu alu (	// @[playground/src/SimTop.scala:156:18]
    ...
    .io_src1   (IsaU_auipc ? pc : _RegFile_io_rdata1),	// @[playground/src/SimTop.scala:26:17, :51:24, :148:21, :157:15]
    .io_src2
  ...
  assign io_pc = pc;	// @[<stdin>:124:3, playground/src/SimTop.scala:26:17]
  assign io_result = _io_result_output;	// @[<stdin>:124:3, playground/src/SimTop.scala:178:17]
  assign io_wen = wen;	// @[<stdin>:124:3, playground/src/SimTop.scala:110:57]
  assign io_imm = Imm;	// @[<stdin>:124:3, playground/src/SimTop.scala:98:39]
endmodule
