...
module Axi4Lite_Sram_Mem(	// @[<stdin>:1611:3]
  ...
  wire _io_ar_ready_output = 1'h1;	// @[<stdin>:1611:3, playground/src/Sram.scala:11:14]
  wire _io_aw_ready_output = 1'h1;	// @[<stdin>:1611:3, playground/src/Sram.scala:11:14]
  wire _io_w_ready_output = 1'h1;	// @[<stdin>:1611:3, playground/src/Sram.scala:11:14]
  ...
  assign io_r_valid = readDataValidReg;	// @[<stdin>:1611:3, playground/src/Sram.scala:17:31]
  assign io_r_bits_resp = 2'h0;	// @[<stdin>:1611:3, playground/src/Sram.scala:25:17]
  assign io_aw_ready = _io_aw_ready_output;	// @[<stdin>:1611:3]
  assign io_w_ready = _io_w_ready_output;	// @[<stdin>:1611:3]
  assign io_b_valid = writeRespValidReg;	// @[<stdin>:1611:3, playground/src/Sram.scala:35:32]
  assign io_b_bits_resp = 2'h0;	// @[<stdin>:1611:3, playground/src/Sram.scala:25:17]
endmodule
