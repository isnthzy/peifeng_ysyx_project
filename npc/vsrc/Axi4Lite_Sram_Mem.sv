...
module Axi4Lite_Sram_Mem(	// @[<stdin>:1857:3]
  input         clock,	// @[<stdin>:1858:11]
                reset,	// @[<stdin>:1859:11]
  ...
  wire [3:0] _io_w_ready_LSFR_io_OutTime;	// @[playground/src/LSFR.scala:24:20]
  wire [3:0] _io_aw_ready_LSFR_io_OutTime;	// @[playground/src/LSFR.scala:24:20]
  wire [3:0] _io_ar_ready_LSFR_io_OutTime;	// @[playground/src/LSFR.scala:24:20]
  reg  [3:0] io_ar_ready_delay;	// @[playground/src/LSFR.scala:21:22]
  reg        io_ar_ready_data;	// @[playground/src/LSFR.scala:22:22]
  wire       _io_ar_ready_output = io_ar_ready_data;	// @[<stdin>:1857:3, playground/src/LSFR.scala:22:22]
  wire       _dpi_sram_io_req_T = _io_ar_ready_output & io_ar_valid;	// @[<stdin>:1857:3, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  wire       _io_aw_ready_output;	// @[<stdin>:1857:3]
  wire       _dpi_sram_io_wr_T = _io_aw_ready_output & io_aw_valid;	// @[<stdin>:1857:3, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  wire       _io_w_ready_output;	// @[<stdin>:1857:3]
  wire       _dpi_sram_io_wr_T_1 = _io_w_ready_output & io_w_valid;	// @[<stdin>:1857:3, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  reg        readDataValidReg;	// @[playground/src/Sram.scala:18:31]
  reg  [3:0] io_aw_ready_delay;	// @[playground/src/LSFR.scala:21:22]
  reg        io_aw_ready_data;	// @[playground/src/LSFR.scala:22:22]
  assign _io_aw_ready_output = io_aw_ready_data;	// @[<stdin>:1857:3, playground/src/LSFR.scala:22:22]
  reg  [3:0] io_w_ready_delay;	// @[playground/src/LSFR.scala:21:22]
  reg        io_w_ready_data;	// @[playground/src/LSFR.scala:22:22]
  assign _io_w_ready_output = io_w_ready_data;	// @[<stdin>:1857:3, playground/src/LSFR.scala:22:22]
  reg        writeRespValidReg;	// @[playground/src/Sram.scala:37:32]
  wire       _io_ar_ready_T = io_ar_ready_delay == 4'h0;	// @[playground/src/LSFR.scala:21:22, :27:15]
  wire       _io_aw_ready_T = io_aw_ready_delay == 4'h0;	// @[playground/src/LSFR.scala:21:22, :27:15]
  wire       _io_w_ready_T = io_w_ready_delay == 4'h0;	// @[playground/src/LSFR.scala:21:22, :27:15]
  always @(posedge clock) begin	// @[<stdin>:1858:11]
    if (reset) begin	// @[<stdin>:1858:11]
      io_ar_ready_delay <= 4'h0;	// @[playground/src/LSFR.scala:21:22]
      ...
      io_aw_ready_delay <= 4'h0;	// @[playground/src/LSFR.scala:21:22]
      io_aw_ready_data <= 1'h0;	// @[playground/src/LSFR.scala:22:{22,35}]
      io_w_ready_delay <= 4'h0;	// @[playground/src/LSFR.scala:21:22]
      ...
      if (_io_ar_ready_T)	// @[playground/src/LSFR.scala:27:15]
        ...
        io_ar_ready_delay <= io_ar_ready_delay - 4'h1;	// @[playground/src/LSFR.scala:21:22, :32:21]
      ...
      if (_io_aw_ready_T)	// @[playground/src/LSFR.scala:27:15]
        ...
        io_aw_ready_delay <= io_aw_ready_delay - 4'h1;	// @[playground/src/LSFR.scala:21:22, :32:21]
      ...
      if (_io_w_ready_T)	// @[playground/src/LSFR.scala:27:15]
        ...
        io_w_ready_delay <= io_w_ready_delay - 4'h1;	// @[playground/src/LSFR.scala:21:22, :32:21]
  ...
  assign io_ar_ready = _io_ar_ready_output;	// @[<stdin>:1857:3]
  assign io_r_valid = readDataValidReg;	// @[<stdin>:1857:3, playground/src/Sram.scala:18:31]
  assign io_r_bits_resp = 2'h0;	// @[<stdin>:1857:3, playground/src/Sram.scala:26:17]
  assign io_aw_ready = _io_aw_ready_output;	// @[<stdin>:1857:3]
  assign io_w_ready = _io_w_ready_output;	// @[<stdin>:1857:3]
  assign io_b_valid = writeRespValidReg;	// @[<stdin>:1857:3, playground/src/Sram.scala:37:32]
  assign io_b_bits_resp = 2'h0;	// @[<stdin>:1857:3, playground/src/Sram.scala:26:17]
endmodule
