  ...
  always @(posedge clock) begin	// @[<stdin>:1858:11]
    if (reset) begin	// @[<stdin>:1858:11]
      ...
      if (_io_ar_ready_T)	// @[playground/src/LSFR.scala:27:15]
        io_ar_ready_delay <= {4'h0, _io_ar_ready_LSFR_io_OutTime};	// @[playground/src/LSFR.scala:21:22, :24:20, :29:12]
      ...
      if (_io_aw_ready_T)	// @[playground/src/LSFR.scala:27:15]
        io_aw_ready_delay <= {4'h0, _io_aw_ready_LSFR_io_OutTime};	// @[playground/src/LSFR.scala:21:22, :24:20, :29:12]
      else	// @[playground/src/LSFR.scala:27:15]
      ...
      if (_io_w_ready_T)	// @[playground/src/LSFR.scala:27:15]
        io_w_ready_delay <= {4'h0, _io_w_ready_LSFR_io_OutTime};	// @[playground/src/LSFR.scala:21:22, :24:20, :29:12]
      else	// @[playground/src/LSFR.scala:27:15]
