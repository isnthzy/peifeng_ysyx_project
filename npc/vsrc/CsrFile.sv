...
module CsrFile(	// @[<stdin>:1129:3]
  input         clock,	// @[<stdin>:1130:11]
                reset,	// @[<stdin>:1131:11]
  ...
  wire        _GEN_1 = io_csr_addr == 12'h300;	// @[playground/src/Csr.scala:46:37, :72:28]
  wire        _GEN_2 = (|io_csr_cmd) & csr_wen;	// @[playground/src/Csr.scala:35:35, :37:22, :60:{18,27}, :69:18, :70:36]
  wire        _GEN_3 = io_csr_addr == 12'h341;	// @[playground/src/Csr.scala:46:37, :73:28]
  wire        _GEN_4 = io_csr_addr == 12'h342;	// @[playground/src/Csr.scala:46:37, :74:28]
  wire        _GEN_5 = io_csr_addr == 12'h343;	// @[playground/src/Csr.scala:46:37, :75:28]
  wire        _GEN_6 = _GEN_0 | _GEN_1 | _GEN_3 | _GEN_4;	// @[playground/src/Csr.scala:40:22, :70:{23,36}, :72:{28,43}, :73:{28,43}, :74:{28,43}, :75:43]
  always @(posedge clock) begin	// @[<stdin>:1130:11]
    if (reset) begin	// @[<stdin>:1130:11]
    ...
    else begin	// @[<stdin>:1130:11]
      if ((|io_csr_cmd) & csr_wen & _GEN_0)	// @[playground/src/Csr.scala:35:35, :36:22, :60:{18,27}, :69:18, :70:{23,36}, :71:14]
        mtvec <= wdata;	// @[playground/src/Csr.scala:36:22, :41:29]
      if (~_GEN_2 | _GEN_0 | ~_GEN_1) begin	// @[playground/src/Csr.scala:37:22, :60:27, :69:18, :70:{23,36}, :72:{28,43}]
      end
      ...
      if (|io_csr_cmd) begin	// @[playground/src/Csr.scala:60:18]
        if (~csr_wen | _GEN_0 | _GEN_1 | ~_GEN_3) begin	// @[playground/src/Csr.scala:35:35, :61:33, :69:18, :70:{23,36}, :72:{28,43}, :73:{28,43}]
        ...
        if (~csr_wen | _GEN_0 | _GEN_1 | _GEN_3 | ~_GEN_4) begin	// @[playground/src/Csr.scala:35:35, :61:33, :69:18, :70:{23,36}, :72:{28,43}, :73:{28,43}, :74:{28,43}]
          if (_GEN)	// @[playground/src/Csr.scala:61:20]
      ...
      if (~_GEN_2 | _GEN_6 | ~_GEN_5) begin	// @[playground/src/Csr.scala:37:22, :40:22, :60:27, :69:18, :70:36, :72:43, :73:43, :74:43, :75:{28,43}]
      end
      else	// @[playground/src/Csr.scala:40:22, :60:27, :69:18, :70:36]
        mtval <= wdata;	// @[playground/src/Csr.scala:40:22, :41:29]
    end
  end // always @(posedge)
  csr_debug_dpic csr_dpic (	// @[playground/src/Csr.scala:80:22]
    .clock      (clock),
    .reset      (reset),
    .csr_valid  (|io_csr_cmd),	// @[playground/src/Csr.scala:60:18]
    .assert_wen (_GEN_2 & ~_GEN_6 & ~_GEN_5)	// @[playground/src/Csr.scala:37:22, :40:22, :43:33, :60:27, :69:18, :70:36, :72:43, :73:43, :74:43, :75:{28,43}, :76:33]
  );
  assign io_out_wen = _csr_wen_T | _csr_wen_T_1;	// @[<stdin>:1129:3, playground/src/Csr.scala:34:{26,35,48}]
  assign io_out = _io_out_output;	// @[<stdin>:1129:3, playground/src/Csr.scala:46:37]
  assign io_epc =
    (|io_csr_cmd) ? (io_csr_cmd == 5'h3 ? mepc : _GEN ? mtvec : 32'h0) : 32'h0;	// @[<stdin>:1129:3, playground/src/Csr.scala:36:22, :38:22, :44:9, :60:{18,27}, :61:{20,33}, :64:13, :66:{20,32}, :67:13]
endmodule
