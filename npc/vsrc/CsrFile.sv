...
module CsrFile(	// @[<stdin>:897:3]
  input         clock,	// @[<stdin>:898:11]
                reset,	// @[<stdin>:899:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:898:11]
    if (reset) begin	// @[<stdin>:898:11]
      ...
      : io_csr_raddr == 12'h342
          ...
          : io_csr_raddr == 12'h341
              ...
              : io_csr_raddr == 12'h300
                  ? mstatus
                  : io_csr_raddr == 12'h305 ? mtvec : 32'h0;	// @[<stdin>:897:3, playground/src/Csr.scala:37:22, :38:22, :39:22, :40:22, :41:22, :47:38]
  assign io_global_mtvec = io_csr_cmd == 5'h4 ? mtvec : 32'h0;	// @[<stdin>:897:3, playground/src/Csr.scala:37:22, :44:18, :57:{18,31}, :58:20]
  assign io_global_mepc = io_csr_cmd == 5'h3 ? mepc : 32'h0;	// @[<stdin>:897:3, playground/src/Csr.scala:37:22, :39:22, :45:17, :66:{18,30}, :67:19]
endmodule
