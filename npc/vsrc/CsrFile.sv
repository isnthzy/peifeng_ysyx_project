...
module CsrFile(	// @[<stdin>:1219:3]
  ...
  assign io_out_wen = _csr_wen_T | _csr_wen_T_1;	// @[<stdin>:1219:3, playground/src/Csr.scala:34:{26,35,48}]
  assign io_out = _io_out_T ? 32'hB : wdata;	// @[<stdin>:1219:3, playground/src/Csr.scala:41:29, :60:{14,26}]
  assign io_epc =
    (|io_csr_cmd) ? (io_csr_cmd == 5'h3 ? mepc : _GEN ? mtvec : 32'h0) : 32'h0;	// @[<stdin>:1219:3, playground/src/Csr.scala:36:22, :38:22, :45:9, :63:{18,27}, :64:{20,33}, :67:13, :69:{20,32}, :70:13]
endmodule
