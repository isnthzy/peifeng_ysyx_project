...
module CsrFile(	// @[<stdin>:816:3]
  ...
  wire        _GEN_2 = io_csr_waddr == 12'h343;	// @[playground/src/Csr.scala:47:38, :76:27]
  wire        _GEN_3 = _GEN | _GEN_0 | _GEN_1 | io_csr_waddr == 12'h342;	// @[playground/src/Csr.scala:41:22, :47:38, :71:{22,35}, :73:{27,42}, :74:{27,42}, :75:{27,42}, :76:42]
  always @(posedge clock) begin	// @[<stdin>:817:11]
    if (reset) begin	// @[<stdin>:817:11]
      ...
      if (~io_csr_wen | _GEN_3 | ~_GEN_2) begin	// @[playground/src/Csr.scala:38:22, :41:22, :70:19, :71:35, :73:42, :74:42, :75:42, :76:{27,42}]
      end
  ...
  csr_debug_dpic csr_dpic (	// @[playground/src/Csr.scala:81:22]
    ...
    .assert_wen (io_csr_wen & ~_GEN_3 & ~_GEN_2)	// @[playground/src/Csr.scala:41:22, :43:33, :70:19, :71:35, :73:42, :74:42, :75:42, :76:{27,42}, :77:31]
  );
  assign io_out =
      ...
      : io_csr_raddr == 12'h342
          ...
          : io_csr_raddr == 12'h341
              ...
              : io_csr_raddr == 12'h300
                  ? mstatus
                  : io_csr_raddr == 12'h305 ? mtvec : 32'h0;	// @[<stdin>:816:3, playground/src/Csr.scala:22:12, :37:22, :38:22, :39:22, :41:22, :47:38]
  assign io_global_mtvec = io_csr_cmd == 5'h4 ? mtvec : 32'h0;	// @[<stdin>:816:3, playground/src/Csr.scala:37:22, :44:18, :57:{18,31}, :58:20]
  assign io_global_mepc = io_csr_cmd == 5'h3 ? mepc : 32'h0;	// @[<stdin>:816:3, playground/src/Csr.scala:37:22, :39:22, :45:17, :66:{18,30}, :67:19]
endmodule
