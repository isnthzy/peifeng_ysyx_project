...
module CsrFile(	// @[<stdin>:1128:3]
  ...
  wire        _GEN_0 = (|io_csr_cmd) & csr_wen;	// @[playground/src/Csr.scala:35:35, :60:18, :69:18]
  wire        _GEN_1 = io_csr_addr == 12'h305;	// @[playground/src/Csr.scala:46:37, :70:23]
  ...
  wire        _GEN_6 = _GEN_1 | _GEN_2 | _GEN_3 | _GEN_4;	// @[playground/src/Csr.scala:40:22, :70:{23,36}, :73:{28,43}, :74:{28,43}, :75:{28,43}, :76:43]
  always @(posedge clock) begin	// @[<stdin>:1129:11]
    if (reset) begin	// @[<stdin>:1129:11]
      ...
      if ((|io_csr_cmd) & csr_wen & _GEN_1)	// @[playground/src/Csr.scala:35:35, :36:22, :60:{18,27}, :69:18, :70:{23,36}, :72:14]
        mtvec <= wdata;	// @[playground/src/Csr.scala:36:22, :41:29]
      if (~_GEN_0 | _GEN_1 | ~_GEN_2) begin	// @[playground/src/Csr.scala:37:22, :60:27, :69:18, :70:{23,36}, :73:{28,43}]
      end
      ...
      if (|io_csr_cmd) begin	// @[playground/src/Csr.scala:60:18]
        if (~csr_wen | _GEN_1 | _GEN_2 | ~_GEN_3) begin	// @[playground/src/Csr.scala:35:35, :61:33, :69:18, :70:{23,36}, :73:{28,43}, :74:{28,43}]
        ...
        if (~csr_wen | _GEN_1 | _GEN_2 | _GEN_3 | ~_GEN_4) begin	// @[playground/src/Csr.scala:35:35, :61:33, :69:18, :70:{23,36}, :73:{28,43}, :74:{28,43}, :75:{28,43}]
          if (_GEN)	// @[playground/src/Csr.scala:61:20]
      ...
      if (~_GEN_0 | _GEN_6 | ~_GEN_5) begin	// @[playground/src/Csr.scala:37:22, :40:22, :60:27, :69:18, :70:36, :73:43, :74:43, :75:43, :76:{28,43}]
      end
  ...
  csr_debug_dpic csr_dpic (	// @[playground/src/Csr.scala:81:22]
    ...
    .assert_wen (_GEN_0 & ~_GEN_6 & ~_GEN_5)	// @[playground/src/Csr.scala:40:22, :43:33, :60:27, :69:18, :70:36, :71:15, :73:43, :74:43, :75:43, :76:{28,43}, :77:33]
  );
