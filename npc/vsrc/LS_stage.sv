...
module LS_stage(	// @[<stdin>:973:3]
  ...
  assign LS_to_wb_ebreak_flag = LS_IO_ebreak_flag;	// @[<stdin>:973:3]
  assign LS_to_wb_wen = LS_IO_wen;	// @[<stdin>:973:3]
  assign LS_to_wb_rd = LS_IO_rd;	// @[<stdin>:973:3]
  assign LS_to_wb_result = casez_tmp_0;	// @[<stdin>:973:3, playground/src/LS_stage.scala:33:47]
  assign LS_to_wb_nextpc = LS_IO_nextpc;	// @[<stdin>:973:3]
endmodule
