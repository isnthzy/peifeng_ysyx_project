...
module LS_stage(	// @[<stdin>:1298:3]
  input         clock,	// @[<stdin>:1299:11]
                reset,	// @[<stdin>:1300:11]
  ...
  output        LS_to_wb_valid,	// @[playground/src/LS_stage.scala:7:12]
                ...
                LS_to_wb_bits_ebreak_flag,	// @[playground/src/LS_stage.scala:7:12]
  ...
  always_comb begin	// @[playground/src/LS_stage.scala:31:46]
    casez (LS_IO_bits_ld_type)	// @[playground/src/LS_stage.scala:31:46]
      ...
      3'b010:
        casez_tmp = {{16{LS_data_sram_rdata[15]}}, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:146:{10,15,37}, playground/src/LS_stage.scala:31:46, :33:37]
      3'b011:
        casez_tmp = {{24{LS_data_sram_rdata[7]}}, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:146:{10,15,37}, playground/src/LS_stage.scala:31:46, :34:37]
      3'b100:
        casez_tmp = {16'h0, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:146:15, :157:10, playground/src/LS_stage.scala:31:46, :33:37]
      3'b101:
        casez_tmp = {24'h0, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:146:15, :157:10, playground/src/LS_stage.scala:31:46, :34:37]
      3'b110:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:31:46]
      default:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:31:46]
  ...
  always_comb begin	// @[playground/src/LS_stage.scala:43:57]
    casez (LS_IO_bits_wb_sel)	// @[playground/src/LS_stage.scala:43:57]
      ...
      2'b01:
        casez_tmp_0 = ram_data;	// @[playground/src/LS_stage.scala:29:30, :43:57]
      2'b10:
  ...
  always @(posedge clock) begin	// @[<stdin>:1299:11]
    if (reset)	// @[<stdin>:1299:11]
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1298:3, playground/src/LS_stage.scala:23:28]
  assign LS_bypass_id_addr = ls_valid & LS_IO_bits_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1298:3, playground/src/LS_stage.scala:19:33, :54:{25,35}]
  assign LS_bypass_id_data = casez_tmp_0;	// @[<stdin>:1298:3, playground/src/LS_stage.scala:43:57]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1298:3, playground/src/LS_stage.scala:19:33, :20:33, :27:28]
  assign LS_to_wb_bits_dpic_bundle_id_inv_flag = LS_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_dpic_bundle_ex_func_flag = LS_IO_bits_dpic_bundle_ex_func_flag;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_jal = LS_IO_bits_dpic_bundle_ex_is_jal;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_ret = LS_IO_bits_dpic_bundle_ex_is_ret;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_rd0 = LS_IO_bits_dpic_bundle_ex_is_rd0;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_ebreak_flag = LS_IO_bits_ebreak_flag;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_wen = LS_IO_bits_wen;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_rd = LS_IO_bits_rd;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1298:3, playground/src/LS_stage.scala:43:57]
  assign LS_to_wb_bits_nextpc = LS_IO_bits_nextpc;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_pc = LS_IO_bits_pc;	// @[<stdin>:1298:3]
  assign LS_to_wb_bits_inst = LS_IO_bits_inst;	// @[<stdin>:1298:3]
endmodule
