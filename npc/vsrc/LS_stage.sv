...
module LS_stage(	// @[<stdin>:1309:3]
  input         clock,	// @[<stdin>:1310:11]
                reset,	// @[<stdin>:1311:11]
  ...
  always_comb begin	// @[playground/src/LS_stage.scala:32:46]
    casez (LS_IO_bits_ld_type)	// @[playground/src/LS_stage.scala:32:46]
      ...
      3'b010:
        casez_tmp = {{16{LS_data_sram_rdata[15]}}, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:173:{10,15,37}, playground/src/LS_stage.scala:32:46, :34:37]
      3'b011:
        casez_tmp = {{24{LS_data_sram_rdata[7]}}, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:173:{10,15,37}, playground/src/LS_stage.scala:32:46, :35:37]
      3'b100:
        casez_tmp = {16'h0, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:173:15, :184:10, playground/src/LS_stage.scala:32:46, :34:37]
      3'b101:
        casez_tmp = {24'h0, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:173:15, :184:10, playground/src/LS_stage.scala:32:46, :35:37]
      3'b110:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:32:46]
      default:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:32:46]
  ...
  always @(posedge clock) begin	// @[<stdin>:1310:11]
    if (reset)	// @[<stdin>:1310:11]
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1309:3, playground/src/LS_stage.scala:24:28]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1309:3, playground/src/LS_stage.scala:20:33, :21:33, :28:28]
  assign LS_to_wb_bits_dpic_bundle_id_inv_flag = LS_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_dpic_bundle_ex_func_flag = LS_IO_bits_dpic_bundle_ex_func_flag;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_jal = LS_IO_bits_dpic_bundle_ex_is_jal;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_ret = LS_IO_bits_dpic_bundle_ex_is_ret;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_rd0 = LS_IO_bits_dpic_bundle_ex_is_rd0;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_ebreak_flag = LS_IO_bits_ebreak_flag;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_wen = LS_IO_bits_wen;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_rd = LS_IO_bits_rd;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1309:3, playground/src/LS_stage.scala:44:57]
  assign LS_to_wb_bits_nextpc = LS_IO_bits_nextpc;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_pc = LS_IO_bits_pc;	// @[<stdin>:1309:3]
  assign LS_to_wb_bits_inst = LS_IO_bits_inst;	// @[<stdin>:1309:3]
  assign LS_to_id_fw_addr = ls_valid & LS_IO_bits_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1309:3, playground/src/LS_stage.scala:20:33, :55:{24,34}]
  assign LS_to_id_fw_data = casez_tmp_0;	// @[<stdin>:1309:3, playground/src/LS_stage.scala:44:57]
endmodule
