...
module LS_stage(	// @[<stdin>:1118:3]
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1118:3, playground/src/LS_stage.scala:16:28]
  assign LS_bypass_id_addr = ls_valid & LS_IO_bits_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1118:3, playground/src/LS_stage.scala:13:33, :61:{25,35}]
  assign LS_bypass_id_data = casez_tmp_0;	// @[<stdin>:1118:3, playground/src/LS_stage.scala:50:57]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1118:3, playground/src/LS_stage.scala:13:33, :14:33, :20:28]
  ...
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1118:3, playground/src/LS_stage.scala:50:57]
