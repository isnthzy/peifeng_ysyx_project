...
module LS_stage(	// @[<stdin>:1314:3]
  ...
  wire        rdata_ok = 1'h1;	// @[playground/src/LS_stage.scala:7:12, :15:30]
  wire        wdata_ok = 1'h1;	// @[playground/src/LS_stage.scala:7:12, :16:30]
  wire        ls_ready_go = 1'h1;	// @[playground/src/LS_stage.scala:7:12, :21:33]
  ...
  assign LS_to_wb_bits_csr_commit_wen = LS_IO_bits_csr_commit_wen;	// @[<stdin>:1314:3]
  assign LS_to_wb_bits_csr_commit_waddr = LS_IO_bits_csr_commit_waddr;	// @[<stdin>:1314:3]
  assign LS_to_wb_bits_csr_commit_wdata = LS_IO_bits_csr_commit_wdata;	// @[<stdin>:1314:3]
  assign LS_to_wb_bits_csr_commit_exception_wen = LS_IO_bits_csr_commit_exception_wen;	// @[<stdin>:1314:3]
  assign LS_to_wb_bits_csr_commit_exception_mcause_in =
    LS_IO_bits_csr_commit_exception_mcause_in;	// @[<stdin>:1314:3]
  assign LS_to_wb_bits_csr_commit_exception_pc_wb = LS_IO_bits_csr_commit_exception_pc_wb;	// @[<stdin>:1314:3]
