...
module LS_stage(	// @[<stdin>:1162:3]
  input         clock,	// @[<stdin>:1163:11]
                reset,	// @[<stdin>:1164:11]
  ...
  always_comb begin	// @[playground/src/LS_stage.scala:43:46]
    casez (LS_IO_bits_ld_type)	// @[playground/src/LS_stage.scala:43:46]
      ...
      3'b010:
        casez_tmp = {{16{_dpi_ls_rdata[15]}}, _dpi_ls_rdata[15:0]};	// @[playground/src/Bundle.scala:116:{10,15,37}, playground/src/LS_stage.scala:31:20, :43:46, :45:34]
      3'b011:
        casez_tmp = {{24{_dpi_ls_rdata[7]}}, _dpi_ls_rdata[7:0]};	// @[playground/src/Bundle.scala:116:{10,15,37}, playground/src/LS_stage.scala:31:20, :43:46, :46:34]
      3'b100:
        casez_tmp = {16'h0, _dpi_ls_rdata[15:0]};	// @[playground/src/Bundle.scala:116:15, :127:10, playground/src/LS_stage.scala:31:20, :43:46, :45:34]
      3'b101:
        casez_tmp = {24'h0, _dpi_ls_rdata[7:0]};	// @[playground/src/Bundle.scala:116:15, :127:10, playground/src/LS_stage.scala:31:20, :43:46, :46:34]
      3'b110:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:43:46]
      default:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:43:46]
  ...
  always @(posedge clock) begin	// @[<stdin>:1163:11]
    if (reset)	// @[<stdin>:1163:11]
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:21:28]
  assign LS_bypass_id_addr = ls_valid & LS_IO_bits_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:18:33, :70:{25,35}]
  assign LS_bypass_id_data = casez_tmp_0;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:59:57]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:18:33, :19:33, :25:28]
  assign LS_to_wb_bits_dpic_bundle_id_inv_flag = LS_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_dpic_bundle_ex_func_flag = LS_IO_bits_dpic_bundle_ex_func_flag;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_jal = LS_IO_bits_dpic_bundle_ex_is_jal;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_ret = LS_IO_bits_dpic_bundle_ex_is_ret;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_dpic_bundle_ex_is_rd0 = LS_IO_bits_dpic_bundle_ex_is_rd0;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_pc_sel = LS_IO_bits_pc_sel;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_csr_addr = LS_IO_bits_csr_addr;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_csr_cmd = LS_IO_bits_csr_cmd;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_ebreak_flag = LS_IO_bits_ebreak_flag;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_wen = LS_IO_bits_wen;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_rd = LS_IO_bits_rd;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:59:57]
  assign LS_to_wb_bits_nextpc = LS_IO_bits_nextpc;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_pc = LS_IO_bits_pc;	// @[<stdin>:1162:3]
  assign LS_to_wb_bits_inst = LS_IO_bits_inst;	// @[<stdin>:1162:3]
  assign LS_clog_id = (|LS_IO_bits_ld_type) & ls_valid & ~rdata_ok;	// @[<stdin>:1162:3, playground/src/LS_stage.scala:14:30, :18:33, :20:{46,66}, :27:58]
endmodule
