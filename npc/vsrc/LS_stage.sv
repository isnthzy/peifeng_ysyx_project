...
module LS_stage(	// @[<stdin>:1156:3]
  ...
  reg  [31:0] casez_tmp;	// @[playground/src/LS_stage.scala:30:46]
  reg  [31:0] casez_tmp_0;	// @[playground/src/LS_stage.scala:46:57]
  reg         ls_valid;	// @[playground/src/LS_stage.scala:19:33]
  wire        ls_ready_go = ~((|LS_IO_bits_ld_type) & ls_valid & ~rdata_ok);	// @[playground/src/LS_stage.scala:14:30, :19:33, :20:33, :21:{19,46,63,66}]
  wire        _LS_IO_ready_output = ~ls_valid | ls_ready_go & LS_to_wb_ready;	// @[playground/src/LS_stage.scala:19:33, :20:33, :22:{18,28,43}]
  always_comb begin	// @[playground/src/LS_stage.scala:30:46]
    casez (LS_IO_bits_ld_type)	// @[playground/src/LS_stage.scala:30:46]
      3'b000:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:30:46]
      3'b001:
        casez_tmp = LS_data_sram_rdata;	// @[playground/src/LS_stage.scala:30:46]
      3'b010:
        casez_tmp = {{16{LS_data_sram_rdata[15]}}, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:131:{10,15,37}, playground/src/LS_stage.scala:30:46, :32:37]
      3'b011:
        casez_tmp = {{24{LS_data_sram_rdata[7]}}, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:131:{10,15,37}, playground/src/LS_stage.scala:30:46, :33:37]
      3'b100:
        casez_tmp = {16'h0, LS_data_sram_rdata[15:0]};	// @[playground/src/Bundle.scala:131:15, :142:10, playground/src/LS_stage.scala:30:46, :32:37]
      3'b101:
        casez_tmp = {24'h0, LS_data_sram_rdata[7:0]};	// @[playground/src/Bundle.scala:131:15, :142:10, playground/src/LS_stage.scala:30:46, :33:37]
      3'b110:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:30:46]
      default:
        casez_tmp = 32'h0;	// @[playground/src/LS_stage.scala:30:46]
    endcase	// @[playground/src/LS_stage.scala:30:46]
  end // always_comb
  wire [31:0] ram_data = casez_tmp;	// @[playground/src/LS_stage.scala:28:30, :30:46]
  always_comb begin	// @[playground/src/LS_stage.scala:46:57]
    casez (LS_IO_bits_wb_sel)	// @[playground/src/LS_stage.scala:46:57]
      2'b00:
        casez_tmp_0 = LS_IO_bits_result;	// @[playground/src/LS_stage.scala:46:57]
      2'b01:
        casez_tmp_0 = ram_data;	// @[playground/src/LS_stage.scala:28:30, :46:57]
      2'b10:
        casez_tmp_0 = LS_IO_bits_pc + 32'h4;	// @[playground/src/LS_stage.scala:46:57, :49:29]
      default:
        casez_tmp_0 = LS_IO_bits_result;	// @[playground/src/LS_stage.scala:46:57]
    endcase	// @[playground/src/LS_stage.scala:46:57]
  end // always_comb
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1156:3, playground/src/LS_stage.scala:22:28]
  assign LS_bypass_id_addr = ls_valid & LS_IO_bits_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1156:3, playground/src/LS_stage.scala:19:33, :57:{25,35}]
  assign LS_bypass_id_data = casez_tmp_0;	// @[<stdin>:1156:3, playground/src/LS_stage.scala:46:57]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1156:3, playground/src/LS_stage.scala:19:33, :20:33, :26:28]
  ...
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1156:3, playground/src/LS_stage.scala:46:57]
