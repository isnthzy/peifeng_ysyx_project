...
module LS_stage(	// @[<stdin>:1443:3]
  ...
  wire        rdata_ok = rdata_valid & LS_IO_bits_ld_wen;	// @[playground/src/LS_stage.scala:17:33, :18:30, :19:25]
  reg         ls_valid;	// @[playground/src/LS_stage.scala:21:33]
  wire        ls_ready_go = ~rdata_ok;	// @[playground/src/LS_stage.scala:18:30, :21:33, :22:33, :23:19]
