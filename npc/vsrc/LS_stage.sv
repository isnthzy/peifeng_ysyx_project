...
module LS_stage(	// @[<stdin>:1443:3]
  ...
  wire        _LS_r_ready_output = 1'h1;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:23:19]
  ...
  assign rdata_valid = _LS_r_ready_output & LS_r_valid;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:17:33, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  assign LS_IO_ready = _LS_IO_ready_output;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:24:28]
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:21:33, :22:33, :28:28]
  ...
  assign LS_to_wb_bits_result = casez_tmp_0;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:55:57]
  ...
  assign LS_to_id_fw_addr = ls_valid & LS_IO_bits_rf_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:21:33, :66:{24,34}]
  assign LS_to_id_fw_data = casez_tmp_0;	// @[<stdin>:1443:3, playground/src/LS_stage.scala:55:57]
  assign LS_r_ready = _LS_r_ready_output;	// @[<stdin>:1443:3]
endmodule
