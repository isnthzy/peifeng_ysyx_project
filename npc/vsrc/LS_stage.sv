...
module LS_stage(	// @[<stdin>:1524:3]
  ...
  reg  [7:0]  casez_tmp;	// @[playground/src/LS_stage.scala:41:60]
  reg  [31:0] casez_tmp_0;	// @[playground/src/LS_stage.scala:54:46]
  reg  [31:0] casez_tmp_1;	// @[playground/src/LS_stage.scala:66:57]
  ...
  always_comb begin	// @[playground/src/LS_stage.scala:41:60]
    casez (LS_IO_bits_addr_low2bit)	// @[playground/src/LS_stage.scala:41:60]
      2'b00:
        casez_tmp = data_ram_rdata[7:0];	// @[playground/src/LS_stage.scala:15:43, :41:60, :42:30]
      2'b01:
        casez_tmp = data_ram_rdata[15:8];	// @[playground/src/LS_stage.scala:15:43, :41:60, :43:30]
      2'b10:
        casez_tmp = data_ram_rdata[23:16];	// @[playground/src/LS_stage.scala:15:43, :41:60, :44:30]
      default:
        casez_tmp = data_ram_rdata[31:24];	// @[playground/src/LS_stage.scala:15:43, :41:60, :45:30]
    endcase	// @[playground/src/LS_stage.scala:41:60]
  end // always_comb
  wire [15:0] load_half_data =
    (&LS_IO_bits_addr_low2bit) | LS_IO_bits_addr_low2bit == 2'h2
      ? data_ram_rdata[31:16]
      : data_ram_rdata[15:0];	// @[playground/src/LS_stage.scala:15:43, :41:60, :48:60, :49:30, :51:30]
  always_comb begin	// @[playground/src/LS_stage.scala:54:46]
    casez (LS_IO_bits_ld_type)	// @[playground/src/LS_stage.scala:54:46]
      3'b000:
        casez_tmp_0 = 32'h0;	// @[playground/src/LS_stage.scala:15:43, :54:46]
      3'b001:
        casez_tmp_0 = data_ram_rdata;	// @[playground/src/LS_stage.scala:15:43, :54:46]
      3'b010:
        casez_tmp_0 = {{16{load_half_data[15]}}, load_half_data};	// @[playground/src/Bundles.scala:212:{10,15,37}, playground/src/LS_stage.scala:48:60, :54:46]
      3'b011:
        casez_tmp_0 = {{24{casez_tmp[7]}}, casez_tmp};	// @[playground/src/Bundles.scala:212:{10,15,37}, playground/src/LS_stage.scala:41:60, :54:46]
      3'b100:
        casez_tmp_0 = {16'h0, load_half_data};	// @[playground/src/Bundles.scala:212:15, :223:10, playground/src/LS_stage.scala:48:60, :54:46]
      3'b101:
        casez_tmp_0 = {24'h0, casez_tmp};	// @[playground/src/Bundles.scala:212:15, :223:10, playground/src/LS_stage.scala:41:60, :54:46]
      3'b110:
        casez_tmp_0 = 32'h0;	// @[playground/src/LS_stage.scala:15:43, :54:46]
      default:
        casez_tmp_0 = 32'h0;	// @[playground/src/LS_stage.scala:15:43, :54:46]
    endcase	// @[playground/src/LS_stage.scala:54:46]
  end // always_comb
  wire [31:0] mem_data = casez_tmp_0;	// @[playground/src/LS_stage.scala:40:30, :54:46]
  always_comb begin	// @[playground/src/LS_stage.scala:66:57]
    casez (LS_IO_bits_wb_sel)	// @[playground/src/LS_stage.scala:66:57]
      2'b00:
        casez_tmp_1 = LS_IO_bits_result;	// @[playground/src/LS_stage.scala:66:57]
      2'b01:
        casez_tmp_1 = mem_data;	// @[playground/src/LS_stage.scala:40:30, :66:57]
      2'b10:
        casez_tmp_1 = LS_IO_bits_pc + 32'h4;	// @[playground/src/LS_stage.scala:66:57, :69:29]
      default:
        casez_tmp_1 = LS_IO_bits_result;	// @[playground/src/LS_stage.scala:66:57]
    endcase	// @[playground/src/LS_stage.scala:66:57]
  end // always_comb
  ...
  assign LS_to_wb_bits_dpic_bundle_ls_ld_data = casez_tmp_1;	// @[<stdin>:1524:3, playground/src/LS_stage.scala:66:57]
  ...
  assign LS_to_wb_bits_result = casez_tmp_1;	// @[<stdin>:1524:3, playground/src/LS_stage.scala:66:57]
  ...
  assign LS_to_id_fw_addr = ls_valid & LS_IO_bits_rf_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1524:3, playground/src/LS_stage.scala:19:33, :79:{24,34}]
  assign LS_to_id_fw_data = casez_tmp_1;	// @[<stdin>:1524:3, playground/src/LS_stage.scala:66:57]
  assign LS_to_id_clog = ls_valid & ~ls_ready_go & LS_IO_bits_ld_wen;	// @[<stdin>:1524:3, playground/src/LS_stage.scala:19:33, :20:33, :77:{30,43}]
