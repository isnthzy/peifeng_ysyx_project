...
module LS_stage(	// @[<stdin>:1478:3]
  ...
  wire        ls_ready_go = ls_clog;	// @[playground/src/LS_stage.scala:18:29, :21:33]
  reg         ls_valid;	// @[playground/src/LS_stage.scala:20:33]
  wire        rdata_valid;	// @[playground/src/LS_stage.scala:17:33]
  assign ls_clog = (~LS_IO_bits_ld_wen | LS_IO_bits_ld_wen & rdata_valid) & ls_valid;	// @[playground/src/LS_stage.scala:17:33, :18:29, :20:33, :22:{14,33,55,71}]
  ...
  assign LS_to_wb_valid = ls_valid & ls_ready_go;	// @[<stdin>:1478:3, playground/src/LS_stage.scala:20:33, :21:33, :28:28]
  ...
  assign LS_to_id_fw_addr = ls_valid & LS_IO_bits_rf_wen ? LS_IO_bits_rd : 5'h0;	// @[<stdin>:1478:3, playground/src/LS_stage.scala:20:33, :68:{24,34}]
  assign LS_to_id_fw_data = casez_tmp_0;	// @[<stdin>:1478:3, playground/src/LS_stage.scala:55:57]
  assign LS_to_id_clog = ls_valid & ~ls_ready_go & LS_IO_bits_ld_wen;	// @[<stdin>:1478:3, playground/src/LS_stage.scala:20:33, :21:33, :66:{30,43}]
