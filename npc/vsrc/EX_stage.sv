...
module EX_stage(	// @[<stdin>:862:3]
  ...
  assign EX_to_ls_ebreak_flag = EX_IO_ebreak_flag;	// @[<stdin>:862:3]
  assign EX_to_ls_wb_sel = EX_IO_wb_sel;	// @[<stdin>:862:3]
  assign EX_to_ls_wen = EX_IO_wen;	// @[<stdin>:862:3]
  assign EX_to_ls_rd = EX_IO_rd;	// @[<stdin>:862:3]
  assign EX_to_ls_result = _Alu_io_result;	// @[<stdin>:862:3, playground/src/EX_stage.scala:12:17]
  assign EX_to_ls_nextpc = EX_IO_nextpc;	// @[<stdin>:862:3]
  assign EX_to_ls_pc = EX_IO_pc;	// @[<stdin>:862:3]
