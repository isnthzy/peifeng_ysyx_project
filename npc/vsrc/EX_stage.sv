...
module EX_stage(	// @[<stdin>:1279:3]
  ...
  reg  [31:0] awaddrReg;	// @[playground/src/EX_stage.scala:126:24]
  ...
  always @(posedge clock) begin	// @[<stdin>:1280:11]
    if (reset) begin	// @[<stdin>:1280:11]
      ...
      awaddrReg <= 32'h0;	// @[playground/src/EX_stage.scala:91:24, :126:24]
      ...
      if (~ReadRequstState & _GEN_4 & _GEN_5)	// @[playground/src/EX_stage.scala:91:24, :94:30, :95:{23,34}, :96:{16,27}, :97:26, :98:24, :104:24]
        araddrReg <= 32'h0;	// @[playground/src/EX_stage.scala:91:24]
      ...
      if (_GEN_6 & _GEN_7) begin	// @[playground/src/EX_stage.scala:126:24, :132:{24,35}, :133:{16,27}, :136:16]
        if (EX_IO_bits_ld_type == 3'h1)	// @[playground/src/EX_stage.scala:79:39]
          awaddrReg <= 32'h0;	// @[playground/src/EX_stage.scala:91:24, :126:24]
        else	// @[playground/src/EX_stage.scala:79:39]
  ...
  assign EX_aw_bits_addr = awaddrReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:126:24]
