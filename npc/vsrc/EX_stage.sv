...
module EX_stage(	// @[<stdin>:864:3]
  input         clock,	// @[<stdin>:865:11]
                reset,	// @[<stdin>:866:11]
  input  [1:0]  EX_IO_st_type,	// @[playground/src/EX_stage.scala:6:12]
  ...
  output [1:0]  EX_to_ls_st_type,	// @[playground/src/EX_stage.scala:6:12]
  ...
  output [31:0] EX_to_ls_src2,	// @[playground/src/EX_stage.scala:6:12]
  ...
  dpi_func dpi_func (	// @[playground/src/EX_stage.scala:54:22]
    .clock     (clock),
    .reset     (reset),
    .func_flag (_dpi_func_io_is_jal_T | _dpi_func_io_func_flag_T_1),	// @[playground/src/EX_stage.scala:22:39, :23:39, :57:50]
    .is_jal    (_dpi_func_io_is_jal_T),	// @[playground/src/EX_stage.scala:22:39]
    .pc        (EX_IO_nextpc),
    .nextpc    (32'h0),	// @[playground/src/EX_stage.scala:30:47]
    .rd        ({27'h0, EX_IO_rd}),	// @[playground/src/EX_stage.scala:61:17]
    .inst      (EX_IO_inst)
  );
  assign EX_to_ls_st_type = EX_IO_st_type;	// @[<stdin>:864:3]
  assign EX_to_ls_ld_type = EX_IO_ld_type;	// @[<stdin>:864:3]
  assign EX_to_ls_ebreak_flag = EX_IO_ebreak_flag;	// @[<stdin>:864:3]
  assign EX_to_ls_wb_sel = EX_IO_wb_sel;	// @[<stdin>:864:3]
  assign EX_to_ls_wen = EX_IO_wen;	// @[<stdin>:864:3]
  assign EX_to_ls_rd = EX_IO_rd;	// @[<stdin>:864:3]
  assign EX_to_ls_src2 = EX_IO_src2;	// @[<stdin>:864:3]
  assign EX_to_ls_result = _Alu_io_result;	// @[<stdin>:864:3, playground/src/EX_stage.scala:12:17]
  assign EX_to_ls_nextpc = EX_IO_nextpc;	// @[<stdin>:864:3]
  assign EX_to_ls_pc = EX_IO_pc;	// @[<stdin>:864:3]
  assign EX_br_bus_is_jump =
    ...
    & ~rs1_lt_rs2_s | EX_IO_br_type == 4'h4 & ~rs1_lt_rs2_u;	// @[<stdin>:864:3, playground/src/EX_stage.scala:18:33, :19:40, :20:34, :22:39, :23:39, :24:{40,50}, :25:{40,50,53}, :26:{40,50}, :27:{40,50}, :28:{40,50,53}, :29:{23,40,50,53}]
  assign EX_br_bus_dnpc =
    EX_IO_br_type == 4'h8
      ...
      : EX_IO_br_type == 4'h7 | EX_IO_br_type == 4'h6 | EX_IO_br_type == 4'h5
        ...
        | EX_IO_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:864:3, playground/src/EX_stage.scala:12:17, :22:39, :23:39, :24:40, :25:{40,53}, :26:40, :27:40, :28:40, :29:40, :30:47, :39:{18,32}]
endmodule
