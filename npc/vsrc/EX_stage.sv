...
module EX_stage(	// @[<stdin>:987:3]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:987:3, playground/src/EX_stage.scala:18:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:987:3, playground/src/EX_stage.scala:15:33, :16:33, :22:28]
  assign EX_to_ls_bits_dpic_bundle_id_inv_flag = EX_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | _EX_to_ls_bits_dpic_bundle_ex_func_flag_T_1;	// @[<stdin>:987:3, playground/src/EX_stage.scala:35:44, :36:44, :84:72]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:987:3, playground/src/EX_stage.scala:35:44]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:987:3, playground/src/EX_stage.scala:86:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:987:3, playground/src/EX_stage.scala:58:21, :87:53]
  assign EX_to_ls_bits_pc_sel = EX_IO_bits_pc_sel;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_csr_addr = EX_IO_bits_csr_addr;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_csr_cmd = EX_IO_bits_csr_cmd;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_st_type = EX_IO_bits_st_type;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_ld_type = EX_IO_bits_ld_type;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_ebreak_flag = EX_IO_bits_ebreak_flag;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_wb_sel = EX_IO_bits_wb_sel;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_wen = EX_IO_bits_wen;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_rd = EX_IO_bits_rd;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_rdata2 = EX_IO_bits_rdata2;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:987:3, playground/src/EX_stage.scala:25:17]
  assign EX_to_ls_bits_nextpc = EX_IO_bits_nextpc;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_pc = EX_IO_bits_pc;	// @[<stdin>:987:3]
  assign EX_to_ls_bits_inst = EX_IO_bits_inst;	// @[<stdin>:987:3]
  assign EX_to_id_addr = ex_valid & EX_IO_bits_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:987:3, playground/src/EX_stage.scala:15:33, :58:{21,31}]
  assign EX_to_id_data = _Alu_io_result;	// @[<stdin>:987:3, playground/src/EX_stage.scala:25:17]
  assign EX_flush_out = _EX_br_bus_is_jump_output;	// @[<stdin>:987:3, playground/src/EX_stage.scala:42:73]
  assign EX_br_bus_is_jump = _EX_br_bus_is_jump_output;	// @[<stdin>:987:3, playground/src/EX_stage.scala:42:73]
    ...
    EX_IO_bits_br_type == 4'h8
      ...
      : EX_IO_bits_br_type == 4'h7 | EX_IO_bits_br_type == 4'h6
        ...
        | EX_IO_bits_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:987:3, playground/src/EX_stage.scala:15:33, :25:17, :35:44, :36:44, :37:45, :38:45, :39:45, :40:45, :41:45, :42:45, :45:52, :54:{18,32}]
endmodule
