...
module EX_stage(	// @[<stdin>:1253:3]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:137:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:137:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:139:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:74:24, :140:53]
  ...
  assign EX_to_preif_epc_target =
    _EX_to_preif_epc_target_T
      ...
      : _EX_to_preif_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:45:61, :60:32, :61:32, :113:30, :114:28]
  assign EX_to_preif_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:26:33, :112:54]
  assign EX_to_preif_Br_B_taken = _EX_to_preif_Br_B_taken_output;	// @[<stdin>:1253:3, playground/src/EX_stage.scala:44:45]
