...
module EX_stage(	// @[<stdin>:1279:3]
  ...
  always @(posedge clock) begin	// @[<stdin>:1280:11]
    if (reset) begin	// @[<stdin>:1280:11]
      ...
      if (~ReadRequstState & _GEN_4 & _GEN_5)	// @[playground/src/EX_stage.scala:93:24, :96:30, :97:{23,34}, :98:{16,27}, :99:26, :100:24, :106:24]
        araddrReg <= ram_raddr;	// @[playground/src/EX_stage.scala:81:20, :93:24]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_mem_addr =
    st_wen ? ram_waddr : ld_wen ? ram_raddr : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:23:28, :24:28, :79:20, :81:20, :93:24, :214:45, :215:50]
