...
module EX_stage(	// @[<stdin>:1221:3]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:29:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33, :26:33, :33:28]
  assign EX_to_ls_bits_csr_commit_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:97:35]
  assign EX_to_ls_bits_csr_commit_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_csr_commit_wdata = _Csr_alu_io_out;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:92:21]
  assign EX_to_ls_bits_csr_commit_exception_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:99:58]
  assign EX_to_ls_bits_csr_commit_exception_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_dpic_bundle_id_inv_flag = EX_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:128:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:128:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:130:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:65:24, :131:53]
  assign EX_to_ls_bits_ld_wen = ld_wen;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:22:28]
  assign EX_to_ls_bits_ld_type = EX_IO_bits_ld_type;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_csr_cmd = EX_IO_bits_csr_cmd;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_wb_sel = EX_IO_bits_wb_sel;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_rf_wen = EX_IO_bits_rf_wen;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_rd = EX_IO_bits_rd;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:36:17]
  assign EX_to_ls_bits_nextpc = EX_IO_bits_nextpc;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_pc = EX_IO_bits_pc;	// @[<stdin>:1221:3]
  assign EX_to_ls_bits_inst = EX_IO_bits_inst;	// @[<stdin>:1221:3]
  assign EX_to_id_fw_addr = ex_valid & EX_IO_bits_rf_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33, :65:{24,34}]
  assign EX_to_id_fw_data = _Alu_io_result;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:36:17]
  assign EX_to_id_csr_ecpt_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:99:58]
  assign EX_to_id_csr_ecpt_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1221:3]
  assign EX_to_id_csr_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1221:3]
  assign EX_to_id_csr_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:97:35]
  assign EX_to_id_csr_wdata = _Csr_alu_io_out;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:92:21]
  assign EX_to_id_clog = (|EX_IO_bits_ld_type) & ex_valid;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33, :61:{37,44}]
  assign EX_to_if_epc_target =
    _EX_to_if_epc_target_T
      ? EX_IO_bits_csr_global_mepc
      : _EX_to_if_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:44:58, :57:39, :58:39, :104:27, :105:28]
  assign EX_to_if_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33, :103:51]
  assign EX_to_if_Br_B_taken = _EX_to_if_Br_B_taken_output;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:43:42]
  assign EX_to_if_Br_B_target =
    ...
    | EX_IO_bits_br_type == 4'h3 | EX_IO_bits_br_type == 4'h2 | EX_IO_bits_br_type == 4'h1
      ? _Alu_io_result
      : 32'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:36:17, :44:58]
  assign EX_to_if_flush =
    (_EX_to_if_Br_B_taken_output | _EX_to_if_epc_target_T | _EX_to_if_epc_target_T_1)
    & ex_valid;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33, :43:42, :57:39, :58:{17,39,53}]
  assign EX_ar_valid = ld_wen & ex_valid;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:22:28, :25:33, :75:22]
  assign EX_ar_bits_addr = _Alu_io_result;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:36:17]
  assign EX_ar_bits_prot = 3'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:77:18]
  assign EX_aw_valid = _EX_aw_valid_T;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:79:21]
  assign EX_aw_bits_addr = _Alu_io_result;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:36:17]
  assign EX_aw_bits_prot = 3'h0;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:77:18]
  assign EX_w_valid = _EX_aw_valid_T;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:79:21]
  assign EX_w_bits_data = EX_IO_bits_rdata2;	// @[<stdin>:1221:3]
  assign EX_w_bits_strb = {4'h0, EX_IO_bits_st_type};	// @[<stdin>:1221:3, playground/src/EX_stage.scala:72:30, :81:17]
  assign EX_b_ready = ex_valid;	// @[<stdin>:1221:3, playground/src/EX_stage.scala:25:33]
endmodule
