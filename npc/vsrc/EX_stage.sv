...
module EX_stage(	// @[<stdin>:1196:3]
  ...
  assign EX_to_id_csr_ecpt_wen = _EX_to_if_epc_taken_T_1 & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:15:33, :47:39, :78:58]
  assign EX_to_id_csr_ecpt_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1196:3]
  assign EX_to_id_csr_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1196:3]
  assign EX_to_id_csr_wen = _Csr_alu_io_wen & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:15:33, :71:21, :76:35]
