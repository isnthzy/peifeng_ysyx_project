...
module EX_stage(	// @[<stdin>:986:3]
  ...
  always @(posedge clock) begin	// @[<stdin>:987:11]
    if (reset)	// @[<stdin>:987:11]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:986:3, playground/src/EX_stage.scala:18:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:986:3, playground/src/EX_stage.scala:15:33, :16:33, :22:28]
  assign EX_to_ls_bits_dpic_bundle_id_inv_flag = EX_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | _EX_to_ls_bits_dpic_bundle_ex_func_flag_T_1;	// @[<stdin>:986:3, playground/src/EX_stage.scala:35:44, :36:44, :83:72]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:986:3, playground/src/EX_stage.scala:35:44]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:986:3, playground/src/EX_stage.scala:85:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:986:3, playground/src/EX_stage.scala:57:21, :86:53]
  assign EX_to_ls_bits_pc_sel = EX_IO_bits_pc_sel;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_csr_addr = EX_IO_bits_csr_addr;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_csr_cmd = EX_IO_bits_csr_cmd;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_st_type = EX_IO_bits_st_type;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_ld_type = EX_IO_bits_ld_type;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_ebreak_flag = EX_IO_bits_ebreak_flag;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_wb_sel = EX_IO_bits_wb_sel;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_wen = EX_IO_bits_wen;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_rd = EX_IO_bits_rd;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_rdata2 = EX_IO_bits_rdata2;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:986:3, playground/src/EX_stage.scala:25:17]
  assign EX_to_ls_bits_nextpc = EX_IO_bits_nextpc;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_pc = EX_IO_bits_pc;	// @[<stdin>:986:3]
  assign EX_to_ls_bits_inst = EX_IO_bits_inst;	// @[<stdin>:986:3]
  assign EX_to_id_addr = ex_valid & EX_IO_bits_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:986:3, playground/src/EX_stage.scala:15:33, :57:{21,31}]
  assign EX_to_id_data = _Alu_io_result;	// @[<stdin>:986:3, playground/src/EX_stage.scala:25:17]
  assign EX_id_no_valid = _EX_br_bus_is_jump_output;	// @[<stdin>:986:3, playground/src/EX_stage.scala:42:23]
  assign EX_br_bus_is_jump = _EX_br_bus_is_jump_output;	// @[<stdin>:986:3, playground/src/EX_stage.scala:42:23]
    ...
    EX_IO_bits_br_type == 4'h8
      ...
      : EX_IO_bits_br_type == 4'h7 | EX_IO_bits_br_type == 4'h6
        ...
        | EX_IO_bits_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:986:3, playground/src/EX_stage.scala:15:33, :25:17, :35:44, :36:44, :37:45, :38:45, :39:45, :40:45, :41:45, :42:45, :44:52, :53:{18,32}]
endmodule
