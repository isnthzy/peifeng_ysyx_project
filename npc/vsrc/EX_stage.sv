...
module EX_stage(	// @[<stdin>:1072:3]
  ...
  wire        _EX_br_bus_taken_output = EX_IO_bits_b_taken & ex_valid;	// @[playground/src/EX_stage.scala:16:33, :37:38]
  wire        _EX_to_ls_bits_dpic_bundle_ex_is_jal_T = EX_IO_bits_br_type == 4'h7;	// @[playground/src/EX_stage.scala:83:62]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:19:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:16:33, :17:33, :23:28]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:83:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:83:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:85:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:57:25, :86:53]
  ...
  assign EX_to_ls_bits_st_type = EX_IO_bits_st_type;	// @[<stdin>:1072:3]
  ...
  assign EX_to_ls_bits_rdata2 = EX_IO_bits_rdata2;	// @[<stdin>:1072:3]
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:26:17]
  ...
  assign EX_bypass_id_addr = ex_valid & EX_IO_bits_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:16:33, :57:{25,35}]
  assign EX_bypass_id_data = _Alu_io_result;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:26:17]
  assign EX_clog_id = (|EX_IO_bits_ld_type) & ex_valid;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:16:33, :53:{34,41}]
  assign EX_flush_out = _EX_br_bus_taken_output & ex_valid;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:16:33, :37:38, :50:32]
  assign EX_br_bus_taken = _EX_br_bus_taken_output;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:37:38]
  assign EX_br_bus_target =
    ...
    | EX_IO_bits_br_type == 4'h3 | EX_IO_bits_br_type == 4'h2 | EX_IO_bits_br_type == 4'h1
      ? _Alu_io_result
      : 32'h0;	// @[<stdin>:1072:3, playground/src/EX_stage.scala:26:17, :38:54]
endmodule
