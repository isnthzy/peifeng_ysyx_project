...
module EX_stage(	// @[<stdin>:1279:3]
  ...
  wire        _EX_b_ready_output = breadyReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:127:24]
  wire        WaitWriteIdle = |WriteRequstState;	// @[playground/src/EX_stage.scala:80:35, :121:31, :152:35]
  wire        BrespFire = _EX_b_ready_output & EX_b_valid;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:83:31, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  assign EX_to_ls_bits_csr_commit_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:171:35]
  assign EX_to_ls_bits_csr_commit_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1279:3]
  assign EX_to_ls_bits_csr_commit_wdata = _Csr_alu_io_out;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:166:21]
  assign EX_to_ls_bits_csr_commit_exception_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:173:58]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:201:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:201:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:203:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:75:24, :204:53]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_mem_addr = st_wen | ld_wen ? _Alu_io_result : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:23:28, :24:28, :39:17, :88:24, :208:{45,52}]
  assign EX_to_ls_bits_dpic_bundle_ex_st_data = st_wen ? EX_IO_bits_rdata2 : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:24:28, :88:24, :209:44]
  ...
  assign EX_to_id_csr_ecpt_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:173:58]
  assign EX_to_id_csr_ecpt_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1279:3]
  assign EX_to_id_csr_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1279:3]
  assign EX_to_id_csr_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:171:35]
  assign EX_to_id_csr_wdata = _Csr_alu_io_out;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:166:21]
  ...
  assign EX_to_preif_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:29:33, :177:54]
  assign EX_to_preif_epc_target =
    _EX_to_preif_epc_target_T
      ? EX_IO_bits_csr_global_mepc
      : _EX_to_preif_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:61:32, :62:32, :88:24, :178:30, :179:28]
  ...
  assign EX_to_preif_Br_B_target =
    ...
    | EX_IO_bits_br_type == 4'h3 | EX_IO_bits_br_type == 4'h2 | EX_IO_bits_br_type == 4'h1
      ? _Alu_io_result
      : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:39:17, :46:61, :88:24]
  assign EX_to_preif_flush = to_flush;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:62:46]
  assign EX_ar_valid = arvalidReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:87:25]
  assign EX_ar_bits_addr = araddrReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:88:24]
  assign EX_ar_bits_prot = 3'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:115:18]
  assign EX_aw_valid = awvalidReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:122:25]
  assign EX_aw_bits_addr = awaddrReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:123:24]
  assign EX_aw_bits_prot = 3'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:115:18]
  assign EX_w_valid = wvalidReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:124:24]
  assign EX_w_bits_data = wdataReg;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:125:23]
  assign EX_w_bits_strb = {4'h0, wstrbReg};	// @[<stdin>:1279:3, playground/src/EX_stage.scala:46:61, :126:23, :159:17]
