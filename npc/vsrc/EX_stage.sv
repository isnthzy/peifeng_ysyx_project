...
module EX_stage(	// @[<stdin>:848:3]
  input         clock,	// @[<stdin>:849:11]
                reset,	// @[<stdin>:850:11]
  ...
  assign EX_to_ls_ebreak_flag = EX_IO_ebreak_flag;	// @[<stdin>:848:3]
  assign EX_to_ls_wb_sel = EX_IO_wb_sel;	// @[<stdin>:848:3]
  assign EX_to_ls_wen = EX_IO_wen;	// @[<stdin>:848:3]
  assign EX_to_ls_rd = EX_IO_rd;	// @[<stdin>:848:3]
  assign EX_to_ls_result = _Alu_io_result;	// @[<stdin>:848:3, playground/src/EX_stage.scala:12:17]
  assign EX_to_ls_nextpc = EX_IO_nextpc;	// @[<stdin>:848:3]
  assign EX_to_ls_pc = EX_IO_pc;	// @[<stdin>:848:3]
  assign EX_br_bus_is_jump =
    ...
    & ~rs1_lt_rs2_s | EX_IO_br_type == 4'h4 & ~rs1_lt_rs2_u;	// @[<stdin>:848:3, playground/src/EX_stage.scala:18:33, :19:40, :20:34, :22:39, :23:39, :24:{39,49}, :25:{39,49,52}, :26:{39,49}, :27:{39,49}, :28:{39,49,52}, :29:{23,39,49,52}]
  assign EX_br_bus_dnpc =
    EX_IO_br_type == 4'h8
      ...
      : EX_IO_br_type == 4'h7 | EX_IO_br_type == 4'h6 | EX_IO_br_type == 4'h5
        ...
        | EX_IO_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:848:3, playground/src/EX_stage.scala:12:17, :22:39, :23:39, :24:39, :25:{39,52}, :26:39, :27:39, :28:39, :29:39, :30:47, :39:{18,32}]
endmodule
