...
module EX_stage(	// @[<stdin>:1196:3]
  ...
  wire        _EX_aw_valid_T = st_wen & ex_valid;	// @[playground/src/EX_stage.scala:23:33, :69:28, :100:21]
  wire        _EX_to_id_csr_wen_output = _Csr_alu_io_wen & ex_valid;	// @[playground/src/EX_stage.scala:23:33, :119:21, :124:35]
  wire        _EX_to_id_csr_ecpt_wen_output = _EX_to_if_epc_target_T_1 & ex_valid;	// @[playground/src/EX_stage.scala:23:33, :55:39, :126:58]
  wire        _EX_to_ls_bits_dpic_bundle_ex_is_jal_T = EX_IO_bits_br_type == 4'h7;	// @[playground/src/EX_stage.scala:155:62]
  always @(posedge clock) begin	// @[<stdin>:1197:11]
    if (reset)	// @[<stdin>:1197:11]
      ex_valid <= 1'h0;	// @[playground/src/EX_stage.scala:23:33]
    else if (_EX_IO_ready_output)	// @[playground/src/EX_stage.scala:26:28]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:155:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:155:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:157:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:62:24, :158:53]
  assign EX_to_ls_bits_ld_wen = ld_wen;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:68:28]
  ...
  assign EX_to_if_epc_target =
    _EX_to_if_epc_target_T
      ...
      : _EX_to_if_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:41:58, :54:39, :55:39, :131:27, :132:28]
  assign EX_to_if_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:23:33, :130:51]
  ...
  assign EX_ar_valid = ld_wen & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:23:33, :68:28, :96:22]
  ...
  assign EX_aw_valid = _EX_aw_valid_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:100:21]
  assign EX_aw_bits_addr = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:33:17]
  assign EX_aw_bits_prot = 3'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:98:18]
  assign EX_w_valid = _EX_aw_valid_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:100:21]
  assign EX_w_bits_data = EX_IO_bits_rdata2;	// @[<stdin>:1196:3]
  assign EX_w_bits_strb = {4'h0, EX_IO_bits_st_type};	// @[<stdin>:1196:3, playground/src/EX_stage.scala:70:30, :102:17]
