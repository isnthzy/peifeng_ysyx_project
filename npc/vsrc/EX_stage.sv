...
module EX_stage(	// @[<stdin>:1196:3]
  ...
  wire [31:0] _Csr_alu_io_out;	// @[playground/src/EX_stage.scala:71:21]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:18:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:15:33, :16:33, :22:28]
  assign EX_to_ls_bits_csr_commit_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:76:35]
  assign EX_to_ls_bits_csr_commit_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1196:3]
  assign EX_to_ls_bits_csr_commit_wdata = _Csr_alu_io_out;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:71:21]
  assign EX_to_ls_bits_csr_commit_exception_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:78:58]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:108:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:108:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:110:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:54:24, :111:53]
  ...
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:25:17]
  ...
  assign EX_to_id_fw_addr = ex_valid & EX_IO_bits_rf_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:15:33, :54:{24,34}]
  assign EX_to_id_fw_data = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:25:17]
  assign EX_to_id_csr_ecpt_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:78:58]
  ...
  assign EX_data_sram_addr = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:25:17]
  assign EX_data_sram_wmask = EX_IO_bits_st_type;	// @[<stdin>:1196:3]
  assign EX_data_sram_wdata = EX_IO_bits_rdata2;	// @[<stdin>:1196:3]
endmodule
