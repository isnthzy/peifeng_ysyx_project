...
module EX_stage(	// @[<stdin>:1196:3]
  ...
  wire        _Csr_alu_io_wen;	// @[playground/src/EX_stage.scala:121:21]
  wire [31:0] _Csr_alu_io_out;	// @[playground/src/EX_stage.scala:121:21]
  wire [31:0] _Alu_io_result;	// @[playground/src/EX_stage.scala:36:17]
  wire        st_wen = |EX_IO_bits_ld_type;	// @[playground/src/EX_stage.scala:23:28, :61:37]
  reg         ex_valid;	// @[playground/src/EX_stage.scala:25:33]
  wire        ld_wen;	// @[playground/src/EX_stage.scala:22:28]
  wire        ex_ready_go =
  ...
  assign ld_wen = |EX_IO_bits_st_type;	// @[playground/src/EX_stage.scala:22:28, :72:30]
  wire        _EX_aw_valid_T = st_wen & ex_valid;	// @[playground/src/EX_stage.scala:23:28, :25:33, :102:21]
  wire        _EX_to_id_csr_wen_output = _Csr_alu_io_wen & ex_valid;	// @[playground/src/EX_stage.scala:25:33, :121:21, :126:35]
  wire        _EX_to_id_csr_ecpt_wen_output = _EX_to_if_epc_target_T_1 & ex_valid;	// @[playground/src/EX_stage.scala:25:33, :58:39, :128:58]
  ...
  Csr_alu Csr_alu (	// @[playground/src/EX_stage.scala:121:21]
  ...
  assign EX_to_ls_bits_csr_commit_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:126:35]
  assign EX_to_ls_bits_csr_commit_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1196:3]
  assign EX_to_ls_bits_csr_commit_wdata = _Csr_alu_io_out;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:121:21]
  assign EX_to_ls_bits_csr_commit_exception_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:128:58]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:65:24, :160:53]
  ...
  assign EX_to_id_csr_ecpt_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:128:58]
  assign EX_to_id_csr_ecpt_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1196:3]
  assign EX_to_id_csr_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1196:3]
  assign EX_to_id_csr_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:126:35]
  assign EX_to_id_csr_wdata = _Csr_alu_io_out;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:121:21]
  ...
  assign EX_to_if_epc_target =
    _EX_to_if_epc_target_T
      ...
      : _EX_to_if_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:44:58, :57:39, :58:39, :133:27, :134:28]
  assign EX_to_if_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:25:33, :132:51]
  ...
  assign EX_ar_valid = ld_wen & ex_valid;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:22:28, :25:33, :98:22]
  assign EX_ar_bits_addr = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:36:17]
  assign EX_ar_bits_prot = 3'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:100:18]
  assign EX_aw_valid = _EX_aw_valid_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:102:21]
  assign EX_aw_bits_addr = _Alu_io_result;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:36:17]
  assign EX_aw_bits_prot = 3'h0;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:100:18]
  assign EX_w_valid = _EX_aw_valid_T;	// @[<stdin>:1196:3, playground/src/EX_stage.scala:102:21]
  assign EX_w_bits_data = EX_IO_bits_rdata2;	// @[<stdin>:1196:3]
  assign EX_w_bits_strb = {4'h0, EX_IO_bits_st_type};	// @[<stdin>:1196:3, playground/src/EX_stage.scala:72:30, :104:17]
