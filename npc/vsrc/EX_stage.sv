...
module EX_stage(	// @[<stdin>:1279:3]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:35:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:32:33, :33:33, :39:28]
  assign EX_to_ls_bits_csr_commit_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:120:35]
  assign EX_to_ls_bits_csr_commit_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1279:3]
  assign EX_to_ls_bits_csr_commit_wdata = _Csr_alu_io_out;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:115:21]
  assign EX_to_ls_bits_csr_commit_exception_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:122:58]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | EX_IO_bits_br_type == 4'h8;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:83:49, :150:{62,72,92}]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:150:62]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:152:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:78:24, :153:53]
  ...
  assign EX_to_ls_bits_dpic_bundle_ex_mem_addr = st_wen | ld_wen ? _Alu_io_result : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:26:28, :27:28, :42:17, :157:{45,53}, :160:45]
  assign EX_to_ls_bits_dpic_bundle_ex_st_data = st_wen ? EX_IO_bits_rdata2 : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:27:28, :158:44, :160:45]
  assign EX_to_ls_bits_addr_low2bit = _Alu_io_result[1:0];	// @[<stdin>:1279:3, playground/src/EX_stage.scala:42:17, :82:33]
  assign EX_to_ls_bits_ld_wen = ld_wen;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:26:28]
  ...
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:42:17]
  ...
  assign EX_to_id_fw_addr = ex_valid & EX_IO_bits_rf_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:32:33, :78:{24,34}]
  assign EX_to_id_fw_data = _Alu_io_result;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:42:17]
  assign EX_to_id_csr_ecpt_wen = _EX_to_id_csr_ecpt_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:122:58]
  assign EX_to_id_csr_ecpt_pc_wb = EX_IO_bits_pc;	// @[<stdin>:1279:3]
  assign EX_to_id_csr_waddr = EX_IO_bits_csr_addr;	// @[<stdin>:1279:3]
  assign EX_to_id_csr_wen = _EX_to_id_csr_wen_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:120:35]
  assign EX_to_id_csr_wdata = _Csr_alu_io_out;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:115:21]
  assign EX_to_id_clog = (|EX_IO_bits_ld_type) & ex_valid;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:29:30, :32:33, :74:44]
  assign EX_to_id_flush = to_flush;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:65:46]
  assign EX_to_if_flush = to_flush;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:65:46]
  assign EX_to_preif_epc_taken = EX_IO_bits_pc_sel & ex_valid;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:32:33, :126:54]
  assign EX_to_preif_epc_target =
    _EX_to_preif_epc_target_T
      ? EX_IO_bits_csr_global_mepc
      : _EX_to_preif_epc_target_T_1 ? EX_IO_bits_csr_global_mtvec : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:64:32, :65:32, :127:30, :128:28, :160:45]
  assign EX_to_preif_Br_B_taken = _EX_to_preif_Br_B_taken_output;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:48:45]
  assign EX_to_preif_Br_B_target =
    ...
    | EX_IO_bits_br_type == 4'h3 | EX_IO_bits_br_type == 4'h2 | EX_IO_bits_br_type == 4'h1
      ? _Alu_io_result
      : 32'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:42:17, :49:61, :160:45]
  assign EX_to_preif_flush = to_flush;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:65:46]
  assign EX_mem_addr = _Alu_io_result & 32'hFFFFFFFC;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:42:17, :95:{30,32}]
  assign EX_write_en = st_wen;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:27:28]
  assign EX_wstrb =
    EX_IO_bits_st_type == 3'h3
      ...
      : EX_IO_bits_st_type == 3'h2
          ...
          : EX_IO_bits_st_type == 3'h1
              ...
              : 4'h0;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:28:30, :42:17, :49:61, :82:33, :83:49, :89:49, :96:46]
  assign EX_wdata = EX_IO_bits_rdata2;	// @[<stdin>:1279:3]
  assign EX_read_en = ld_wen;	// @[<stdin>:1279:3, playground/src/EX_stage.scala:26:28]
endmodule
