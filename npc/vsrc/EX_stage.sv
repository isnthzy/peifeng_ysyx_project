...
module EX_stage(	// @[<stdin>:873:3]
  input         clock,	// @[<stdin>:874:11]
                reset,	// @[<stdin>:875:11]
  ...
  assign EX_to_ls_st_type = EX_IO_st_type;	// @[<stdin>:873:3]
  assign EX_to_ls_ld_type = EX_IO_ld_type;	// @[<stdin>:873:3]
  assign EX_to_ls_ebreak_flag = EX_IO_ebreak_flag;	// @[<stdin>:873:3]
  assign EX_to_ls_wb_sel = EX_IO_wb_sel;	// @[<stdin>:873:3]
  assign EX_to_ls_wen = EX_IO_wen;	// @[<stdin>:873:3]
  assign EX_to_ls_rd = EX_IO_rd;	// @[<stdin>:873:3]
  assign EX_to_ls_rdata2 = EX_IO_rdata2;	// @[<stdin>:873:3]
  assign EX_to_ls_result = _Alu_io_result;	// @[<stdin>:873:3, playground/src/EX_stage.scala:12:17]
  assign EX_to_ls_nextpc = EX_IO_nextpc;	// @[<stdin>:873:3]
  assign EX_to_ls_pc = EX_IO_pc;	// @[<stdin>:873:3]
  assign EX_br_bus_is_jump =
    ...
    & ~rs1_lt_rs2_s | EX_IO_br_type == 4'h4 & ~rs1_lt_rs2_u;	// @[<stdin>:873:3, playground/src/EX_stage.scala:18:33, :19:40, :20:34, :22:39, :23:39, :24:{40,50}, :25:{40,50,53}, :26:{40,50}, :27:{40,50}, :28:{40,50,53}, :29:{23,40,50,53}]
  assign EX_br_bus_dnpc =
    EX_IO_br_type == 4'h8
      ...
      : EX_IO_br_type == 4'h7 | EX_IO_br_type == 4'h6 | EX_IO_br_type == 4'h5
        ...
        | EX_IO_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:873:3, playground/src/EX_stage.scala:12:17, :22:39, :23:39, :24:40, :25:{40,53}, :26:40, :27:40, :28:40, :29:40, :30:47, :39:{18,32}]
endmodule
