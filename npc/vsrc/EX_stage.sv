...
module EX_stage(	// @[<stdin>:995:3]
  input         clock,	// @[<stdin>:996:11]
                reset,	// @[<stdin>:997:11]
  ...
  always @(posedge clock) begin	// @[<stdin>:996:11]
    if (reset)	// @[<stdin>:996:11]
  ...
  assign EX_IO_ready = _EX_IO_ready_output;	// @[<stdin>:995:3, playground/src/EX_stage.scala:19:28]
  assign EX_to_ls_valid = ex_valid & ex_ready_go;	// @[<stdin>:995:3, playground/src/EX_stage.scala:16:33, :17:33, :23:28]
  assign EX_to_ls_bits_dpic_bundle_id_inv_flag = EX_IO_bits_dpic_bundle_id_inv_flag;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_dpic_bundle_ex_func_flag =
    _EX_to_ls_bits_dpic_bundle_ex_is_jal_T | _EX_to_ls_bits_dpic_bundle_ex_func_flag_T_1;	// @[<stdin>:995:3, playground/src/EX_stage.scala:36:44, :37:44, :94:72]
  assign EX_to_ls_bits_dpic_bundle_ex_is_jal = _EX_to_ls_bits_dpic_bundle_ex_is_jal_T;	// @[<stdin>:995:3, playground/src/EX_stage.scala:36:44]
  assign EX_to_ls_bits_dpic_bundle_ex_is_ret = EX_IO_bits_inst == 32'h8067;	// @[<stdin>:995:3, playground/src/EX_stage.scala:96:55]
  assign EX_to_ls_bits_dpic_bundle_ex_is_rd0 = EX_IO_bits_rd == 5'h0;	// @[<stdin>:995:3, playground/src/EX_stage.scala:68:25, :97:53]
  assign EX_to_ls_bits_pc_sel = EX_IO_bits_pc_sel;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_csr_addr = EX_IO_bits_csr_addr;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_csr_cmd = EX_IO_bits_csr_cmd;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_st_type = EX_IO_bits_st_type;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_ld_type = EX_IO_bits_ld_type;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_ebreak_flag = EX_IO_bits_ebreak_flag;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_wb_sel = EX_IO_bits_wb_sel;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_wen = EX_IO_bits_wen;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_rd = EX_IO_bits_rd;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_rdata2 = EX_IO_bits_rdata2;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_result = _Alu_io_result;	// @[<stdin>:995:3, playground/src/EX_stage.scala:26:17]
  assign EX_to_ls_bits_nextpc = EX_IO_bits_nextpc;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_pc = EX_IO_bits_pc;	// @[<stdin>:995:3]
  assign EX_to_ls_bits_inst = EX_IO_bits_inst;	// @[<stdin>:995:3]
  assign EX_bypass_id_addr = ex_valid & EX_IO_bits_wen ? EX_IO_bits_rd : 5'h0;	// @[<stdin>:995:3, playground/src/EX_stage.scala:16:33, :68:{25,35}]
  assign EX_bypass_id_data = _Alu_io_result;	// @[<stdin>:995:3, playground/src/EX_stage.scala:26:17]
  assign EX_clog_id = (|EX_IO_bits_ld_type) & ex_valid;	// @[<stdin>:995:3, playground/src/EX_stage.scala:16:33, :64:{34,41}]
  assign EX_flush_out = _EX_br_bus_is_jump_output & ex_valid;	// @[<stdin>:995:3, playground/src/EX_stage.scala:16:33, :43:73, :61:34]
  assign EX_br_bus_is_jump = _EX_br_bus_is_jump_output;	// @[<stdin>:995:3, playground/src/EX_stage.scala:43:73]
    ...
    EX_IO_bits_br_type == 4'h8
      ...
      : EX_IO_bits_br_type == 4'h7 | EX_IO_bits_br_type == 4'h6
        ...
        | EX_IO_bits_br_type == 4'h1
          ? _Alu_io_result
          : 32'h0;	// @[<stdin>:995:3, playground/src/EX_stage.scala:16:33, :26:17, :36:44, :37:44, :38:45, :39:45, :40:45, :41:45, :42:45, :43:45, :47:52, :56:{18,32}]
endmodule
