...
module Decode(	// @[<stdin>:122:3]
  ...
  assign io_pc_sel =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
      ...
      | _ctrlSignals_T_73 | _GEN_1) & (_ctrlSignals_T_332 | _ctrlSignals_T_85);	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_A_sel =
    ...
    & (_ctrlSignals_T_7 | ~_GEN_5
       & (_GEN_4 | ~(_ctrlSignals_T_75 | _ctrlSignals_T_497 | _ctrlSignals_T_332)
          & (_ctrlSignals_T_85 | _ctrlSignals_T_125)));	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_B_sel =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
    | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
    | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _ctrlSignals_T_21 | _ctrlSignals_T_23
    ...
    | _ctrlSignals_T_33 | _ctrlSignals_T_35 | _GEN_7
      ? 2'h0
      : _GEN_2 ? 2'h1 : _GEN_1 ? 2'h2 : _ctrlSignals_T_332 ? 2'h0 : {1'h0, _GEN_6};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_imm_sel =
    _GEN_10
      ? 3'h3
      : _ctrlSignals_T_5
          ...
          : _ctrlSignals_T_7
              ? 3'h1
              : _GEN_5 ? 3'h5 : _GEN_9 ? 3'h1 : _GEN_8 ? 3'h2 : {2'h0, _GEN_7};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_alu_op =
    _ctrlSignals_T_1
      ? 4'hB
      : _ctrlSignals_T_3
                                                                                      ...
                                                                                      : _ctrlSignals_T_73
                                                                                          ...
                                                                                          : _GEN_1
                                                                                              ...
                                                                                              : _ctrlSignals_T_332
                                                                                                | ~_GEN_6
                                                                                                  ? 4'hC
                                                                                                  : 4'h0;	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_br_type =
    _GEN_10
      ? 4'h0
      : _ctrlSignals_T_5
                  ...
                  : _ctrlSignals_T_11
                      ...
                      : _ctrlSignals_T_13
                          ...
                          : _ctrlSignals_T_15
                              ...
                              : _ctrlSignals_T_17
                                  ? 4'h1
                                  : {1'h0, _ctrlSignals_T_19, 2'h0};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_st_type =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
    | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
    | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _GEN_9
      ? 4'h0
      : _ctrlSignals_T_31 ? 4'h1 : _ctrlSignals_T_33 ? 4'h3 : {4{_ctrlSignals_T_35}};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_ld_type =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7 | _GEN_5
      ...
      : _ctrlSignals_T_21
          ...
          : _ctrlSignals_T_23
              ...
              : _ctrlSignals_T_25
                  ? 3'h1
                  : _ctrlSignals_T_27 ? 3'h5 : {_ctrlSignals_T_29, 2'h0};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_sel =
    _GEN_10
      ? 2'h0
      : _GEN_11
              ...
              : _GEN_9
                  ...
                  : _GEN_3
                      ...
                      : {2{_ctrlSignals_T_75 | _ctrlSignals_T_497 | _ctrlSignals_T_332
                             | _GEN_6}};	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_en =
    ...
    & (_GEN_9 | ~_GEN_8
       & (_ctrlSignals_T_37 | _ctrlSignals_T_39 | _ctrlSignals_T_41 | _ctrlSignals_T_43
          ...
          | _ctrlSignals_T_497));	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_csr_cmd =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
    | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
    | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _GEN_4
      ...
      : _ctrlSignals_T_75
          ...
          : _ctrlSignals_T_497
              ...
              : _ctrlSignals_T_332
                  ? 5'h3
                  : _ctrlSignals_T_85 ? 5'h4 : _ctrlSignals_T_125 ? 5'h5 : 5'h0;	// @[<stdin>:122:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_illegal =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
      | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
      | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _ctrlSignals_T_21 | _ctrlSignals_T_23
