...
module Decode(	// @[<stdin>:34:3]
  ...
  output [1:0]  io_st_type,	// @[playground/src/Decode.scala:231:14]
  ...
  assign io_B_sel =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
      ...
      | _ctrlSignals_T_33 | _ctrlSignals_T_35 | _GEN_5) & (_GEN_1 | _ctrlSignals_T_150);	// @[<stdin>:34:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_imm_sel =
    _GEN_8
      ? 3'h3
      : _ctrlSignals_T_5
          ...
          : _ctrlSignals_T_7
              ? 3'h1
              : _GEN_4 ? 3'h5 : _GEN_7 ? 3'h1 : _GEN_6 ? 3'h2 : {2'h0, _GEN_5};	// @[<stdin>:34:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_alu_op =
    _ctrlSignals_T_1
      ? 4'hB
  ...
  assign io_st_type =
    ...
    | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _GEN_7
      ? 2'h0
      : _ctrlSignals_T_31 ? 2'h3 : _ctrlSignals_T_33 ? 2'h2 : {1'h0, _ctrlSignals_T_35};	// @[<stdin>:34:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_ld_type =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7 | _GEN_4
      ...
      : _ctrlSignals_T_21
          ...
          : _ctrlSignals_T_23
              ...
              : _ctrlSignals_T_25
                  ? 3'h1
                  : _ctrlSignals_T_27 ? 3'h5 : {_ctrlSignals_T_321, 2'h0};	// @[<stdin>:34:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_sel =
    _GEN_8
      ? 2'h0
      : _GEN_9
          ? 2'h2
          : _GEN_4 ? 2'h0 : _GEN_7 ? 2'h1 : _GEN_2 ? 2'h0 : {2{_ctrlSignals_T_150}};	// @[<stdin>:34:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_en =
