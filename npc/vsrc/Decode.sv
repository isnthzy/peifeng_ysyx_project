...
module Decode(	// @[<stdin>:49:3]
  ...
  assign io_pc_sel =
    ...
    & (_ctrlSignals_T_332 | _ctrlSignals_T_85);	// @[<stdin>:49:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_A_sel =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5)
    & (_ctrlSignals_T_7 | ~_GEN_3
       & (_GEN_2 | ~_ctrlSignals_T_332 & (_ctrlSignals_T_85 | _ctrlSignals_T_166)));	// @[<stdin>:49:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_B_sel =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
      | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
  ...
  assign io_imm_sel =
    _GEN_8
      ...
      : _ctrlSignals_T_5
          ...
          : _ctrlSignals_T_7
              ? 3'h1
              : _GEN_3 ? 3'h5 : _GEN_7 ? 3'h1 : _GEN_6 ? 3'h2 : {2'h0, _GEN_5};	// @[<stdin>:49:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_alu_op =
    _ctrlSignals_T_1
      ? 4'hB
