...
module Decode(	// @[<stdin>:35:3]
  input  [31:0] io_inst,	// @[playground/src/Decode.scala:231:14]
  output        io_A_sel,	// @[playground/src/Decode.scala:231:14]
  ...
  wire        _ctrlSignals_T_321 = _GEN == 10'h283;	// @[src/main/scala/chisel3/util/Lookup.scala:31:38]
  ...
  wire        _ctrlSignals_T_447 = _GEN_0 == 17'h3B3;	// @[src/main/scala/chisel3/util/Lookup.scala:31:38]
  wire        _ctrlSignals_T_150 = io_inst == 32'h100073;	// @[src/main/scala/chisel3/util/Lookup.scala:31:38]
  wire        _GEN_1 =
    ...
    | _ctrlSignals_T_71 | _ctrlSignals_T_447;	// @[src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  wire        _GEN_2 =
  ...
  wire        _GEN_3 =
    ...
    | _ctrlSignals_T_321 | _GEN_2;	// @[src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  wire        _GEN_4 =
  ...
  assign io_A_sel =
    ...
    & (_ctrlSignals_T_7 | ~_GEN_4 & (_GEN_3 | _ctrlSignals_T_150));	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_B_sel =
    ~(_ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
      | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
      | _ctrlSignals_T_17 | _ctrlSignals_T_19 | _ctrlSignals_T_21 | _ctrlSignals_T_23
      | _ctrlSignals_T_25 | _ctrlSignals_T_27 | _ctrlSignals_T_321 | _ctrlSignals_T_31
      | _ctrlSignals_T_33 | _ctrlSignals_T_35 | _GEN_5) & (_GEN_1 | _ctrlSignals_T_150);	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_imm_sel =
    _GEN_8
      ? 3'h3
      : _ctrlSignals_T_5
          ...
          : _ctrlSignals_T_7
              ? 3'h1
              : _GEN_4 ? 3'h5 : _GEN_7 ? 3'h1 : _GEN_6 ? 3'h2 : {2'h0, _GEN_5};	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_alu_op =
    _ctrlSignals_T_1
      ? 4'hB
      : _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7 | _ctrlSignals_T_9
        ...
        | _ctrlSignals_T_27 | _ctrlSignals_T_321 | _ctrlSignals_T_31 | _ctrlSignals_T_33
                                                                      ...
                                                                      : _ctrlSignals_T_69
                                                                          ...
                                                                          : _ctrlSignals_T_71
                                                                              ...
                                                                              : _ctrlSignals_T_447
                                                                                  ...
                                                                                  : _ctrlSignals_T_150
                                                                                      ? 4'h0
                                                                                      : 4'hF;	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_br_type =
    _GEN_8
      ? 4'h0
      : _ctrlSignals_T_5
                  ...
                  : _ctrlSignals_T_11
                      ...
                      : _ctrlSignals_T_13
                          ...
                          : _ctrlSignals_T_15
                              ...
                              : _ctrlSignals_T_17
                                  ? 4'h1
                                  : {1'h0, _ctrlSignals_T_19, 2'h0};	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_st_type =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7
    | _ctrlSignals_T_9 | _ctrlSignals_T_11 | _ctrlSignals_T_13 | _ctrlSignals_T_15
    ...
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _ctrlSignals_T_5 | _ctrlSignals_T_7 | _GEN_4
      ...
      : _ctrlSignals_T_21
          ...
          : _ctrlSignals_T_23
              ...
              : _ctrlSignals_T_25
                  ? 3'h1
                  : _ctrlSignals_T_27 ? 3'h5 : {_ctrlSignals_T_321, 2'h0};	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_sel =
    _GEN_8
      ? 2'h0
      : _GEN_9
          ? 2'h2
          : _GEN_4 ? 2'h0 : _GEN_7 ? 2'h1 : _GEN_2 ? 2'h0 : {2{_ctrlSignals_T_150}};	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_wb_en =
    _ctrlSignals_T_1 | _ctrlSignals_T_3 | _GEN_9 | ~_GEN_4
    & (_GEN_7 | ~_GEN_6
       & (_ctrlSignals_T_37 | _ctrlSignals_T_39 | _ctrlSignals_T_41 | _ctrlSignals_T_43
          | _ctrlSignals_T_45 | _ctrlSignals_T_47 | _ctrlSignals_T_49 | _ctrlSignals_T_51
          ...
          | _ctrlSignals_T_69 | _ctrlSignals_T_71 | _ctrlSignals_T_447));	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_csr_cmd = _GEN_10 | ~_ctrlSignals_T_150 ? 3'h0 : 3'h5;	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
  assign io_illegal = ~_GEN_10 & ~_ctrlSignals_T_150;	// @[<stdin>:35:3, src/main/scala/chisel3/util/Lookup.scala:31:38, :34:39]
endmodule
