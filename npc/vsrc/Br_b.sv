...
module Br_b(	// @[<stdin>:921:3]
  ...
  assign io_taken =
    ...
    | io_br_type == 4'h5 & ~rs1_lt_rs2_s | io_br_type == 4'h4 & ~rs1_lt_rs2_u;	// @[<stdin>:921:3, playground/src/Br_cond.scala:13:32, :14:39, :15:33, :17:{27,37}, :18:{27,37,40}, :19:{27,37}, :20:{27,37}, :21:{27,37,40}, :22:{13,27,37,40}]
endmodule
