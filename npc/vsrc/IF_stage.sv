  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      if (ReadRequstState) begin	// @[playground/src/IF_stage.scala:62:30]
        ...
        arvalidReg <= if_valid | arvalidReg;	// @[playground/src/IF_stage.scala:29:33, :58:25, :64:19, :67:17]
        ReadRequstState <= if_valid | ReadRequstState;	// @[playground/src/IF_stage.scala:29:33, :62:30, :64:19, :65:22]
      end
      if (~ReadRequstState & if_valid)	// @[playground/src/IF_stage.scala:29:33, :59:24, :62:30, :63:{23,33}, :64:19, :66:16]
