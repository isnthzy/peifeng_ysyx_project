...
module IF_stage(	// @[<stdin>:80:3]
  ...
  assign IF_IO_ready = _IF_IO_ready_output;	// @[<stdin>:80:3, playground/src/IF_stage.scala:25:28]
  assign IF_to_id_valid = ~if_flush & if_valid & if_ready_go;	// @[<stdin>:80:3, playground/src/IF_stage.scala:19:30, :22:33, :23:33, :29:22]
