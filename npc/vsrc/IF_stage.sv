...
module IF_stage(	// @[<stdin>:3:3]
  ...
  wire [31:0] if_inst = inst_is_valid ? IF_r_bits_data : 32'h0;	// @[playground/src/IF_stage.scala:24:35, :49:36, :83:18, :84:12]
  wire        _GEN = ReadRequstState & IF_ar_ready;	// @[playground/src/IF_stage.scala:62:30, :67:45, :68:22, :69:22]
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      arvalidReg <= ~ReadRequstState | ~_GEN & arvalidReg;	// @[playground/src/IF_stage.scala:58:25, :62:30, :63:{23,33}, :66:15, :67:45, :68:22, :69:22, :70:17]
      if (ReadRequstState) begin	// @[playground/src/IF_stage.scala:62:30]
      end
      else	// @[playground/src/IF_stage.scala:62:30]
        araddrReg <= if_nextpc;	// @[playground/src/IF_stage.scala:47:33, :59:24]
      ReadRequstState <= ~ReadRequstState | ~_GEN & ReadRequstState;	// @[playground/src/IF_stage.scala:62:30, :63:{23,33}, :64:20, :67:45, :68:22, :69:22]
    end
  end // always @(posedge)
