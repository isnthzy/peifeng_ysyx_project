...
module IF_stage(	// @[<stdin>:3:3]
  ...
  wire        _IF_ar_valid_output;	// @[<stdin>:3:3]
  wire        if_ready_go = _IF_ar_valid_output & IF_to_id_ready;	// @[<stdin>:3:3, playground/src/IF_stage.scala:27:33, :28:19]
  ...
  assign _IF_ar_valid_output = DoAddrReadReg;	// @[<stdin>:3:3, playground/src/IF_stage.scala:51:28]
  ...
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      DoAddrReadReg <= if_valid & ~reset;	// @[playground/src/IF_stage.scala:26:33, :51:28, :52:{29,32}]
    end
  end // always @(posedge)
  ...
  assign IF_ar_valid = _IF_ar_valid_output;	// @[<stdin>:3:3]
