...
module IF_stage(	// @[<stdin>:3:3]
  ...
  reg         DoAddrReadReg_REG;	// @[playground/src/IF_stage.scala:53:25]
  wire [31:0] if_inst = _IF_r_ready_output & IF_r_valid ? IF_r_bits_data : 32'h0;	// @[<stdin>:3:3, playground/src/IF_stage.scala:45:36, :58:18, :59:12, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  always @(posedge clock) begin	// @[<stdin>:4:11]
    if (reset) begin	// @[<stdin>:4:11]
      ...
      DoAddrReadReg <= DoAddrReadReg_REG;	// @[playground/src/IF_stage.scala:51:28, :53:25]
    end
    DoAddrReadReg_REG <= ~reset;	// @[playground/src/IF_stage.scala:53:{25,26}]
  end // always @(posedge)
  ...
  assign IF_ar_bits_prot = 3'h0;	// @[<stdin>:3:3, playground/src/IF_stage.scala:56:18]
  ...
  assign IF_aw_bits_prot = 3'h0;	// @[<stdin>:3:3, playground/src/IF_stage.scala:56:18]
  ...
  assign IF_w_bits_strb = 8'h0;	// @[<stdin>:3:3, playground/src/IF_stage.scala:65:17]
