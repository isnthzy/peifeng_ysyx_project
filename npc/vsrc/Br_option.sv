...
module Br_option(	// @[<stdin>:1458:3]
  ...
  assign io_out_taken = io_Jtype_taken | io_Btype_taken;	// @[<stdin>:1458:3, playground/src/Br_cond.scala:86:31]
  assign io_out_target = io_Jtype_taken ? io_Jtype_target : io_Btype_target;	// @[<stdin>:1458:3, playground/src/Br_cond.scala:87:21]
endmodule
