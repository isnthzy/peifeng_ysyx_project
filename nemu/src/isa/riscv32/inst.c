...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw  , N, int t=cpu.CSRs[csr]; cpu.CSRs[csr]=src1; Reg(rd)=t);
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc=isa_raise_intr(Reg(15),cpu.CSRs[0x305]));
