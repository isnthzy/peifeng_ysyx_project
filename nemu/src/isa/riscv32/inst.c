...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, Reg(rd) = ((int64_t)((int64_t)src1 * (int64_t)src2)>>32);printf("%lx \n%x\n",(int64_t)((int64_t)src1 * (int64_t)src2),(int32_t)((int64_t)((int64_t)src1 * (int64_t)src2)>>32)));
